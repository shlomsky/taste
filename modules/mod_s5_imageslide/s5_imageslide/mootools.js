...
}});Element.extend({effect:function(B,A){return new Fx.Style(this,B,A);}});Fx.Transition=function(B,A){A=A||[];if($type(A)!="array"){A=[A];}return $extend(B,{easeIn:function(C){return B(C,A);
