...
class menuFacileForms {
	...
	function buttons($action)
	{
		...
		menuFacileForms::button(BFText::_('TOOLBAR_MANAGERECS'),    $action, 'managerecs'    );
		menuFacileForms::button(BFText::_('TOOLBAR_MANAGEMENUS'),   $action, 'managemenus'   );
		menuFacileForms::button(BFText::_('TOOLBAR_MANAGEFORMS'),   $action, 'manageforms'   );
		menuFacileForms::button(BFText::_('TOOLBAR_MANAGESCRIPTS'), $action, 'managescripts' );
		menuFacileForms::button(BFText::_('TOOLBAR_MANAGEPIECES'),  $action, 'managepieces'  );
		menuFacileForms::button(BFText::_('TOOLBAR_CONFIGURATION'), $action, '', 'config'    );
		echo '</span>';
	} // buttons
	...
	function INSTPACKAGE_MENU() {
		...
		JToolBarHelper::custom('start',   'upload.png', 'upload_f2.png', BFText::_('TOOLBAR_INSTPKG'),   false);
		JToolBarHelper::custom('delpkgs', 'delete.png', 'delete_f2.png', BFText::_('TOOLBAR_UINSTPKGS'), false);
		JToolBarHelper::custom('edit',    'cancel.png', 'cancel_f2.png', BFText::_('TOOLBAR_CANCEL'),    false);
