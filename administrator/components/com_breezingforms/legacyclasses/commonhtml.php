		...
		foreach( $menus as $menu ) {
			...
			<tr>
				<td width="90" valign="top">
					<?php echo BFText::_( 'Menu' ); ?>
				</td>
				<td>
					<a href="javascript:go2('go2menu','<?php echo $menu->menutype; ?>');" title="<?php echo BFText::_( 'Go to Menu' ); ?>">
						<?php echo $menu->menutype; ?></a>
				</td>
			</tr>
			<tr>
				<td width="90" valign="top">
				<?php echo BFText::_( 'Link Name' ); ?>
				</td>
				<td>
					<strong>
					<a href="javascript:go2('go2menuitem','<?php echo $menu->menutype; ?>','<?php echo $menu->id; ?>');" title="<?php echo BFText::_( 'Go to Menu Item' ); ?>">
			...
			<tr>
				<td width="90" valign="top">
					<?php echo BFText::_( 'State' ); ?>
				</td>
				<td>
					<?php
					switch ( $menu->published ) {
						case -2:
							echo '<font color="red">'. BFText::_( 'Trashed' ) .'</font>';
							break;
						case 0:
							echo BFText::_( 'UnPublished' );
							break;
						case 1:
						default:
							echo '<font color="green">'. BFText::_( 'Published' ) .'</font>';
							break;
					}
					?>
				</td>
