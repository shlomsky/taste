...
class facileFormsPiece
{
	function edit($option, $pkg, $ids)
	{
		...
		$typelist = array();
		$typelist[] = array('Untyped',BFText::_('PIECES_UNTYPED'));
		$typelist[] = array('Before Form',BFText::_('PIECES_BEFOREFORM'));
		$typelist[] = array('After Form',BFText::_('PIECES_AFTERFORM'));
		$typelist[] = array('Begin Submit',BFText::_('PIECES_BEGINSUBMIT'));
		$typelist[] = array('End Submit',BFText::_('PIECES_ENDSUBMIT'));
	...
	function copy($option, $pkg, $ids)
	{
		...
		$msg = $total.' '.BFText::_('PIECES_SUCCOPIED');
