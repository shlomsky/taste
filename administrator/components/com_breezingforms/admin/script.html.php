...
class HTML_facileFormsScript
{
	function edit($option, $pkg, &$row, &$typelist)
	{
		...
		$action = $row->id ? BFText::_('SCRIPTS_EDITSCRIPT') : BFText::_('SCRIPTS_ADDSCRIPT');
?>
		...
		function checkIdentifier(value, name)
		{
			...
			var error = '';
			if (value == '')
				error += "<?php echo BFText::_('SCRIPTS_ENTERNAME'); ?>\n";
			else
				if (invalidChars.test(value))
					error += "<?php echo BFText::_('SCRIPTS_ENTERIDENT'); ?>\n";
			return error;
		} // checkIdentifier
		...
		function submitbutton(pressbutton)
		{
			...
			if (pressbutton != 'cancel') {
				...
				if (form.title.value == '') error += "<?php echo BFText::_('SCRIPTS_ENTTITLE'); ?>\n";
			} // if
			if (error != '')
				alert(error);
			else
		...
		function createCode()
		{
			...
			if (name=='') {
				alert("<?php echo BFText::_('SCRIPTS_ENTNAMEFIRST'); ?>");
				return;
			} // if
			...
			switch (stype) {
				...
				case 'Element Action':
					if (!confirm("<?php echo BFText::_('SCRIPTS_CREATEACTCODE'); ?>\n<?php echo BFText::_('SCRIPTS_EXISTAPP'); ?>")) return;
					code =
				...
				case 'Element Init':
					if (!confirm("<?php echo BFText::_('SCRIPTS_CREATEINICODE'); ?>\n<?php echo BFText::_('SCRIPTS_EXISTAPP'); ?>")) return;
					code =
				...
				case 'Element Validation':
					if (!confirm("<?php echo BFText::_('SCRIPTS_CREATEVALCODE'); ?>\n<?php echo BFText::_('SCRIPTS_EXISTAPP'); ?>")) return;
					code =
				...
				case 'Form Init':
					if (!confirm("<?php echo BFText::_('SCRIPTS_CREATEFINICODE'); ?>\n<?php echo BFText::_('SCRIPTS_EXISTAPP'); ?>")) return;
					code =
						"function "+name+"()\n"+
						"{\n"+
						"} // "+name+"\n";
				...
				case 'Form Submitted':
					if (!confirm("<?php echo BFText::_('SCRIPTS_CREATESUBCODE'); ?>\n<?php echo BFText::_('SCRIPTS_EXISTAPP'); ?>")) return;
					code =
				...
				case 'Untyped':
					if (!confirm("<?php echo BFText::_('SCRIPTS_CREATEUNTCODE'); ?>\n<?php echo BFText::_('SCRIPTS_EXISTAPP'); ?>")) return;
					code =
						"function "+name+"()\n"+
						"{\n"+
						"} // "+name+"\n";
				...
				default:
					alert("<?php echo BFText::_('SCRIPTS_UNKNOWNTYPE'); ?> "+stype);
			...
			if (oldcode != '')
				form.code.value =
					code+
					"\n// -------------- <?php echo BFText::_('SCRIPTS_OLDBELOW'); ?> --------------\n\n"+
					oldcode;
			else
...
?>
			...
			<tr>
				<td></td>
				<td nowrap><?php echo BFText::_('SCRIPTS_PUBLISHED'); ?>:</td>
				<td nowrap><?php echo mosHTML::yesnoRadioList("published", "", $row->published); ?></td>
				<td></td>
			</tr>
			<tr>
				<td></td>
				<td nowrap><?php echo BFText::_('SCRIPTS_PACKAGE'); ?>:</td>
				<td nowrap>
...
?>
			...
			<tr>
				<td></td>
				<td nowrap><?php echo BFText::_('SCRIPTS_TYPE'); ?>:</td>
				<td nowrap>
...
?>
			...
			<tr>
				<td></td>
				<td nowrap colspan="2">
					<?php echo BFText::_('SCRIPTS_DESCRIPTION'); ?>:
			...
			<tr>
				...
				<td nowrap colspan="2">
					...
					<?php echo BFText::_('SCRIPTS_CODE'); ?>:
					<br/>
...
<?php
	...
	{
		switch ($type) {
			case 'Untyped': return BFText::_('SCRIPTS_UNTYPED');
			case 'Element Init': return BFText::_('SCRIPTS_ELEMENTINIT');
			case 'Element Action': return BFText::_('SCRIPTS_ELEMENTACTION');
			case 'Element Validation': return BFText::_('SCRIPTS_ELEMENTVALID');
			case 'Form Init': return BFText::_('SCRIPTS_FORMINIT');
			case 'Form Submitted': return BFText::_('SCRIPTS_FORMSUBMIT');
			default:;
		} // switch
		return '???';
	} // typeName
		...
		<script type="text/javascript">
			...
			function submitbutton(pressbutton)
			{
				...
				switch (pressbutton) {
					...
					case 'remove':
						if (form.boxchecked.value==0) {
							alert("<?php echo BFText::_('SCRIPTS_SELSCRIPTSFIRST'); ?>");
							return;
						} // if
						break;
					default:
				...
				if (pressbutton == 'remove')
					if (!confirm("<?php echo BFText::_('SCRIPTS_ASKDELETE'); ?>")) return;
			...
			<tr>
				<td width="50%" nowrap>
					<table class="adminheading">
						<tr><th nowrap class="sections">BreezingForms <?php echo $ff_version; ?><br/><span class="componentheading"><?php echo BFText::_('SCRIPTS_MANAGESCRIPTS'); ?></span></th></tr>
					</table>
				</td>
				<td nowrap>
					<?php echo BFText::_('SCRIPTS_PACKAGE'); ?>:
...
?>
		...
		<table cellpadding="4" cellspacing="0" border="0" width="100%" class="adminlist">
			<tr>
				...
				<th nowrap align="left"><?php echo BFText::_('SCRIPTS_TITLE'); ?></th>
				<th nowrap align="left"><?php echo BFText::_('SCRIPTS_NAME'); ?></th>
				<th nowrap align="left"><?php echo BFText::_('SCRIPTS_TYPE'); ?></th>
				<th nowrap align="right">ID</th>
				<th nowrap align="center"><?php echo BFText::_('SCRIPTS_PUBLISHED'); ?></th>
				<th align="left" width="100%"><?php echo BFText::_('SCRIPTS_DESCRIPTION'); ?></th>
			</tr>
<?php
			$k = 0;
