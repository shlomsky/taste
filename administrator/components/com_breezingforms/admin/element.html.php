...
class HTML_facileFormsElement
{
	...
	{
		global $mainframe;
		$ff_mossite = $mainframe->getSiteURL();
?>
		...
		<table cellpadding="4" cellspacing="1" border="0" class="adminform" style="width:300px;">
			<tr><th colspan="5" class="title">BreezingForms - <?php echo BFText::_('ELEMENTS_NEWTYPE'); ?></th></tr>
			<tr>
				<td></td>
				<td valign="top">
					<fieldset><legend><strong><?php echo BFText::_('ELEMENTS_STATICS'); ?></strong></legend>
						<table cellpadding="4" cellspacing="1" border="0" class="adminform">
							<tr><td nowrap><input type="radio" id="newtype1" name="newtype" value='Static Text/HTML' checked="checked"/><label for="newtype1"> <?php echo BFText::_('ELEMENTS_STATICTEXT'); ?></label></td></tr>
							<tr><td nowrap><input type="radio" id="newtype2" name="newtype" value='Rectangle'/><label for="newtype2"> <?php echo BFText::_('ELEMENTS_RECTANGLE'); ?></label></td></tr>
							<tr><td nowrap><input type="radio" id="newtype3" name="newtype" value='Image'/><label for="newtype3"> <?php echo BFText::_('ELEMENTS_IMAGE'); ?></label></td></tr>
							<tr><td nowrap><input type="radio" id="newtype4" name="newtype" value='Tooltip'/><label for="newtype4"> <?php echo BFText::_('ELEMENTS_TOOLTIP'); ?></label></td></tr>
							<tr><td nowrap><input type="radio" id="newtype5" name="newtype" value='Captcha'/><label for="newtype4"> <?php echo BFText::_('ELEMENTS_CAPTCHA'); ?></label></td></tr>
						</table>
					</fieldset>
					<fieldset><legend><strong><?php echo BFText::_('ELEMENTS_BUTTONS'); ?></strong></legend>
						<table cellpadding="4" cellspacing="1" border="0" class="adminform">
							<tr><td nowrap><input type="radio" id="newtype10" name="newtype" value='Regular Button'/><label for="newtype10"> <?php echo BFText::_('ELEMENTS_REGBUTTON'); ?></label></td></tr>
							<tr><td nowrap><input type="radio" id="newtype11" name="newtype" value='Graphic Button'/><label for="newtype11"> <?php echo BFText::_('ELEMENTS_GRAPHBUTTON'); ?></label></td></tr>
							<tr><td nowrap><input type="radio" id="newtype12" name="newtype" value='Icon'/><label for="newtype12"> <?php echo BFText::_('ELEMENTS_ICON'); ?></label></td></tr>
						</table>
					</fieldset>
				</td>
				<td valign="top">
					<fieldset><legend><strong><?php echo BFText::_('ELEMENTS_INPUTS'); ?></strong></legend>
						<table cellpadding="4" cellspacing="1" border="0" class="adminform">
							<tr><td nowrap><input type="radio" id="newtype20" name="newtype" value='Checkbox'/><label for="newtype20"> <?php echo BFText::_('ELEMENTS_CHECKBOX'); ?></label></td></tr>
							<tr><td nowrap><input type="radio" id="newtype21" name="newtype" value='Radio Button'/><label for="newtype21"> <?php echo BFText::_('ELEMENTS_RADIO'); ?></label></td></tr>
							<tr><td nowrap><input type="radio" id="newtype22" name="newtype" value='Text'/><label for="newtype22"> <?php echo BFText::_('ELEMENTS_TEXT'); ?></label></td></tr>
							<tr><td nowrap><input type="radio" id="newtype23" name="newtype" value='Textarea'/><label for="newtype23"> <?php echo BFText::_('ELEMENTS_TEXTAREA'); ?></label></td></tr>
							<tr><td nowrap><input type="radio" id="newtype24" name="newtype" value='Select List'/><label for="newtype24"> <?php echo BFText::_('ELEMENTS_SELECT'); ?></label></td></tr>
							<tr><td nowrap><input type="radio" id="newtype25" name="newtype" value='Query List'/><label for="newtype25"> <?php echo BFText::_('ELEMENTS_QUERYLIST'); ?></label></td></tr>
							<tr><td nowrap><input type="radio" id="newtype26" name="newtype" value='File Upload'/><label for="newtype26"> <?php echo BFText::_('ELEMENTS_UPLOAD'); ?></label></td></tr>
							<tr><td nowrap><input type="radio" id="newtype27" name="newtype" value='Hidden Input'/><label for="newtype27"> <?php echo BFText::_('ELEMENTS_HIDDEN'); ?></label></td></tr>
						</table>
					</fieldset>
				</td>
				<td></td>
...
<?php
	...
	{
		switch ($type) {
			case 'Static Text/HTML': $disptype = BFText::_('ELEMENTS_STATICTEXT'); break;
			case 'Rectangle':        $disptype = BFText::_('ELEMENTS_RECTANGLE'); break;
			case 'Image':            $disptype = BFText::_('ELEMENTS_IMAGE'); break;
			case 'Tooltip':          $disptype = BFText::_('ELEMENTS_TOOLTIP'); break;
			case 'Query List':       $disptype = BFText::_('ELEMENTS_QUERYLIST'); break;
			case 'Regular Button':   $disptype = BFText::_('ELEMENTS_REGBUTTON'); break;
			case 'Graphic Button':   $disptype = BFText::_('ELEMENTS_GRAPHBUTTON'); break;
			case 'Icon':             $disptype = BFText::_('ELEMENTS_ICON'); break;
			case 'Checkbox':         $disptype = BFText::_('ELEMENTS_CHECKBOX'); break;
			case 'Radio Button':     $disptype = BFText::_('ELEMENTS_RADIO'); break;
			case 'Select List':      $disptype = BFText::_('ELEMENTS_SELECT'); break;
			case 'Text':             $disptype = BFText::_('ELEMENTS_TEXT'); break;
			case 'Textarea':         $disptype = BFText::_('ELEMENTS_TEXTAREA'); break;
			case 'File Upload':      $disptype = BFText::_('ELEMENTS_UPLOAD'); break;
			case 'Hidden Input':     $disptype = BFText::_('ELEMENTS_HIDDEN'); break;
	...
	function edit($option, $tabpane, $pkg, &$row, &$lists)
	{
		...
		global $mainframe;
		$ff_mossite = $mainframe->getSiteURL();
		$action = $row->id ? BFText::_('ELEMENTS_EDIT') : BFText::_('ELEMENTS_ADD');
...
?>
		...
		function checkIdentifier(value, name)
		{
			...
			var error = '';
			if (value == '')
				error += "<?php echo BFText::_('ELEMENTS_ENTNAME'); ?>\n";
			else
				if (invalidChars.test(value))
					error += "<?php echo BFText::_('ELEMENTS_ENTIDENT'); ?>\n";
			return error;
		} // checkIdentifier
		...
		function submitbutton(pressbutton)
		{
			...
			if (pressbutton != 'cancel') {
				if (form.title.value == '')
					error += "<?php echo BFText::_('ELEMENTS_TITLEEMPTY'); ?>\n";
...
?>
		...
		function createQueryCode()
		{
			...
			if (!confirm("<?php echo BFText::_('ELEMENTS_ASKCREATEQUERY'); ?>\n<?php echo BFText::_('ELEMENTS_EXISTAPP'); ?>")) return;
			code =
				"global $database;\n"+
				"\n"+
				"$database->setQuery(\n"+
		...
		function qcolDisplay()
		{
			...
			for (r = 0; r < qcolRowCnt; r++) {
				...
				if (skip > 0 || span < 1) {
					...
					if (span > 1) {
						attr += '<?php echo BFText::_('ELEMENTS_SPAN'); ?>('+span+') ';
						skip = span-1;
					} // if
					switch (data[qcolThalign]) {
						case '1': attr += '<?php echo BFText::_('ELEMENTS_LEFT'); ?> '; break;
						case '2': attr += '<?php echo BFText::_('ELEMENTS_CENTER'); ?> '; break;
						case '3': attr += '<?php echo BFText::_('ELEMENTS_RIGHT'); ?> '; break;
						case '4': attr += '<?php echo BFText::_('ELEMENTS_JUSTIFY'); ?> '; break;
						default : ;
					} // switch
					switch (data[qcolThvalign]) {
						case '1': attr += '<?php echo BFText::_('ELEMENTS_TOP'); ?> '; break;
						case '2': attr += '<?php echo BFText::_('ELEMENTS_MIDDLE'); ?> '; break;
						case '3': attr += '<?php echo BFText::_('ELEMENTS_BOTTOM'); ?> '; break;
						case '4': attr += '<?php echo BFText::_('ELEMENTS_BASELINE'); ?> '; break;
						default : ;
					} // switch
					switch (data[qcolThwrap]) {
						case '1': attr += '<?php echo BFText::_('ELEMENTS_NOWRAP'); ?>'; break;
						default : ;
					} // switch
				} // if
				...
				// ordering
				if (r > 0)
					row.cells[qcolCellOrderup].innerHTML = '<a href="javascript:qcolOrderup('+r+')"><img src="images/uparrow.png" alt="^" border="0"/><\/a>';
				else
					row.cells[qcolCellOrderup].innerHTML = '';
				if (r < qcolRowCnt-1)
					row.cells[qcolCellOrderdown].innerHTML = '<a href="javascript:qcolOrderdown('+r+')"><img src="images/downarrow.png" alt="v" border="0"/><\/a>';
				else
		...
		{
			if (!qcolSelects()) {
				alert('<?php echo BFText::_('ELEMENTS_SELECTCOLUMNS'); ?>');
				return;
			} // if
			var r;
		...
		function qcolDelete()
		{
			...
			if (!confirm('<?php echo BFText::_('ELEMENTS_ASKDELCOLUMNS'); ?>')) return;
			var r;
...
?>
		<div id="SelectOptionDialog" style="position:absolute;top:380px;left:45%;z-index:100;display:none;">
			...
			<form name='SelectOptionForm' onsubmit='okOption();return false;'>
				<tr><th colspan="4" class="title">FacileForms - <?php echo BFText::_('ELEMENTS_NEWSELOPT'); ?></th></tr>
				<tr>
					<td></td>
					<td><?php echo BFText::_('ELEMENTS_TEXT'); ?>:</td>
					<td><input type="text" size="50" value="" name="optionText" class="inputbox"/></td>
					<td></td>
				</tr>
				<tr>
					<td></td>
					<td><?php echo BFText::_('ELEMENTS_VALUE'); ?>:</td>
					<td><input type="text" size="50" value="" name="optionValue" class="inputbox"/></td>
					<td></td>
				</tr>
				<tr>
					<td></td>
					<td><?php echo BFText::_('ELEMENTS_SELECTED'); ?>:</td>
					<td><?php echo mosHTML::yesnoRadioList("optionSelected", "", 0); ?></td>
					<td></td>
				</tr>
				<tr>
					<td></td>
					<td colspan="2" style="text-align:right">
						<input type="button" value="<?php echo BFText::_('ELEMENTS_OKBUTTON'); ?>" onclick="okOption()" class="button">
						&nbsp;&nbsp;
						<input type="button" value="<?php echo BFText::_('ELEMENTS_ABORTBUTT'); ?>" onclick="quitOption()" class="button">
					</td>
					<td></td>
				</tr>
			</table>
...
?>
		<div id="QueryColDialog" style="position:absolute;top:120px;left:30%;z-index:100;display:none;">
			...
			<table cellpadding="4" cellspacing="1" border="0" class="adminform" style="width:550px">
				<tr><th colspan="4" class="title">FacileForms - <?php echo BFText::_('ELEMENTS_EDITQUERYCOL'); ?></th></tr>
				<tr>
					<td></td>
					<td>
						<fieldset><legend><?php echo BFText::_('ELEMENTS_HEADER'); ?></legend>
						<table class="adminform">
							<tr>
								<td nowrap><?php echo BFText::_('ELEMENTS_TITLE'); ?>:</td>
								<td nowrap>
									<input type="text" size="50" maxlength="500" name="colTitle" class="inputbox"/>
<?php
									echo mosToolTip(BFText::_('ELEMENTS_QCOLTIPTITLE'));
?>
								</td>
							</tr>
							<tr>
								<td nowrap><?php echo BFText::_('FORMS_CLASSFOR'); ?> &lt;th&gt;:</td>
								<td nowrap>
									<input type="text" size="30" maxlength="30" name="colClass1" class="inputbox"/>
								</td>
							</tr>
							<tr>
								<td nowrap>&lt;th&gt; <?php echo BFText::_('ELEMENTS_SPAN'); ?>:</td>
								<td nowrap>
									<input type="text" size="6" maxlength="6" name="colThspan" class="inputbox"/>
								</td>
							</tr>
							<tr>
								<td nowrap><?php echo BFText::_('ELEMENTS_ATTRIBUTES'); ?>:</td>
								<td nowrap>
									<select name="colThalign" size="1" class="inputbox">
										<option value="0" selected="selected"><?php echo BFText::_('ELEMENTS_NONE'); ?></option>
										<option value="1"><?php echo BFText::_('ELEMENTS_LEFT'); ?></option>
										<option value="2"><?php echo BFText::_('ELEMENTS_CENTER'); ?></option>
										<option value="3"><?php echo BFText::_('ELEMENTS_RIGHT'); ?></option>
										<option value="4"><?php echo BFText::_('ELEMENTS_JUSTIFY'); ?></option>
									</select>
									<select name="colThvalign" size="1" class="inputbox">
										<option value="0" selected="selected"><?php echo BFText::_('ELEMENTS_NONE'); ?></option>
										<option value="1"><?php echo BFText::_('ELEMENTS_TOP'); ?></option>
										<option value="2"><?php echo BFText::_('ELEMENTS_MIDDLE'); ?></option>
										<option value="3"><?php echo BFText::_('ELEMENTS_BOTTOM'); ?></option>
										<option value="4"><?php echo BFText::_('ELEMENTS_BASELINE'); ?></option>
									</select>
									<select name="colThwrap" size="1" class="inputbox">
										<option value="0" selected="selected"><?php echo BFText::_('ELEMENTS_NONE'); ?></option>
										<option value="1"><?php echo BFText::_('ELEMENTS_NOWRAP'); ?></option>
									</select>
								</td>
							</tr>
						</table>
				...
				<tr>
					<td></td>
					<td>
						<fieldset><legend><?php echo BFText::_('ELEMENTS_DATA'); ?></legend>
						<table class="adminform">
							<tr>
								<td nowrap><?php echo BFText::_('ELEMENTS_NAME'); ?>:</td>
								<td nowrap>
									<input type="text" size="30" maxlength="30" name="colName" class="inputbox"/>
<?php
									echo mosToolTip(BFText::_('ELEMENTS_QCOLTIPNAME'));
?>
								</td>
							</tr>
							<tr>
								<td nowrap><?php echo BFText::_('FORMS_CLASSFOR'); ?> &lt;td(1)&gt;:</td>
								<td nowrap>
									<input type="text" size="30" maxlength="30" name="colClass2" class="inputbox"/>
								</td>
							</tr>
							<tr>
								<td nowrap><?php echo BFText::_('FORMS_CLASSFOR'); ?> &lt;td(2)&gt;:</td>
								<td nowrap>
									<input type="text" size="30" maxlength="30" name="colClass3" class="inputbox"/>
								</td>
							</tr>
							<tr>
								<td nowrap><?php echo BFText::_('ELEMENTS_WIDTH'); ?>:</td>
								<td nowrap>
							...
							<tr>
								<td nowrap colspan="2">
									<?php echo BFText::_('ELEMENTS_VALUE'); ?>:
				...
				<tr>
					...
					<td nowrap colspan="2" style="text-align:right">
						<a class="toolbar" href="javascript:qcolOk();" onmouseout="MM_swapImgRestore();"  onmouseover="MM_swapImage('colSave','','images/save_f2.png',1);">
							<img src="images/save.png"  alt="" name="colSave" border="0" align="middle" />&nbsp;<?php echo BFText::_('TOOLBAR_SAVE'); ?>
						</a>&nbsp;&nbsp;
						<a class="toolbar" href="javascript:qcolCancel();" onmouseout="MM_swapImgRestore();"  onmouseover="MM_swapImage('colCancel','','images/cancel_f2.png',1);">
							<img src="images/cancel.png"  alt="" name="colCancel" border="0" align="middle" />&nbsp;<?php echo BFText::_('TOOLBAR_CANCEL'); ?>
						</a>
					</td>
					<td></td>
				</tr>
...
?>
		...
		<table cellpadding="0" cellspacing="0" border="0" class="adminform" style="width:775px;">
			<tr><th colspan="3" class="title">FacileForms - <?php echo $action; ?> <?php echo HTML_facileFormsElement::displayType($row->type); ?></th></tr>
			<tr>
				<td></td>
				<td width="100%">
<?php
		...
		$tabs->startTab(BFText::_('ELEMENTS_SETTINGS'),"tab_settings");
?>
...
<?php
					echo mosToolTip(BFText::_('ELEMENTS_TIPTITLE'));
?>
				</td>
				<td></td>
			</tr>
...
<?php
					echo mosToolTip(BFText::_('ELEMENTS_TIPNAME'));
?>
				</td>
				<td></td>
			</tr>
...
?>
			<tr>
				<td></td>
				<td nowrap><?php echo BFText::_('FORMS_CLASSFOR'); ?> &lt;<?php echo $elemname; ?>&gt;:</td>
				<td nowrap>
...
?>
			<tr>
				<td></td>
				<td nowrap><?php echo BFText::_('FORMS_CLASSFOR'); ?> &lt;tr(header)&gt;:</td>
				<td nowrap>
			...
			<tr>
				<td></td>
				<td nowrap><?php echo BFText::_('FORMS_CLASSFOR'); ?> &lt;tr(data1)&gt;:</td>
				<td nowrap>
			...
			<tr>
				<td></td>
				<td nowrap><?php echo BFText::_('FORMS_CLASSFOR'); ?> &lt;tr(data2)&gt;:</td>
				<td nowrap>
			...
			<tr>
				<td></td>
				<td nowrap><?php echo BFText::_('FORMS_CLASSFOR'); ?> &lt;tr(footer)&gt;:</td>
				<td nowrap>
			...
			<tr>
				<td></td>
				<td nowrap><?php echo BFText::_('FORMS_CLASSFOR'); ?> &lt;td(footer)&gt;:</td>
				<td nowrap>
...
?>
			<tr>
				<td></td>
				<td nowrap><?php echo BFText::_('ELEMENTS_ORDERING'); ?>:</td>
			...
			<tr>
				<td></td>
				<td nowrap><?php echo BFText::_('ELEMENTS_PUBLISHED'); ?>:</td>
...
?>
			<tr>
				<td></td>
				<td nowrap><?php echo BFText::_('ELEMENTS_INCINLOG'); ?>:</td>
				<td nowrap><?php echo mosHTML::yesnoRadioList("logging", "", $row->logging); ?></td>
				<td></td>
			</tr>
<?php
					break;
...
?>
			<tr>
				<td></td>
				<td nowrap><?php echo BFText::_('ELEMENTS_POSITION'); ?> X:</td>
				<td nowrap>
					...
					&nbsp;&nbsp;&nbsp;&nbsp;<?php echo BFText::_('ELEMENTS_POSITION'); ?> Y:
			...
			<tr>
				...
				<td nowrap>
					<input size="6" maxlength="6" name="width" value="<?php echo $row->width; ?>" class="inputbox"/><select name="widthmode" size="1" class="inputbox">
						<option value="0"<?php if ($row->widthmode==0) echo ' selected="selected"'; ?>><?php echo BFText::_('ELEMENTS_COLUMNS'); ?></option>
						<option value="1"<?php if ($row->widthmode==1) echo ' selected="selected"'; ?>>px</option>
					</select>
					&nbsp;&nbsp;&nbsp;&nbsp;<?php echo BFText::_('ELEMENTS_HEIGHT'); ?>:
					<input size="6" maxlength="6" name="height" value="<?php echo $row->height; ?>" class="inputbox"/><select name="heightmode" size="1" class="inputbox">
						<option value="0"<?php if ($row->heightmode==0) echo ' selected="selected"'; ?>><?php echo BFText::_('ELEMENTS_ROWS'); ?></option>
...
?>
			...
			<tr>
				<td></td>
				<td nowrap><?php echo BFText::_('ELEMENTS_HEIGHT'); ?>:</td>
				<td nowrap>
...
?>
			<tr>
				...
				<td nowrap>
					...
					&nbsp;&nbsp;&nbsp;&nbsp;<?php echo BFText::_('ELEMENTS_MAXLENGTH'); ?>:
					<input size="6" maxlength="6" name="height" value="<?php echo $row->height; ?>" class="inputbox"/> <?php echo BFText::_('ELEMENTS_COLUMNS'); ?>
				</td>
				<td></td>
			</tr>
			<tr>
				<td></td>
				<td nowrap><?php echo BFText::_('ELEMENTS_MAILBACK'); ?>:</td>
				<td nowrap>
					<?php $yeschecked = ''; if ($row->mailback == 1) $yeschecked = 'checked="checked"'; ?>
					<?php $nochecked = ''; if ($row->mailback == 0) $nochecked = 'checked="checked"'; ?>
					<?php echo BFText::_('NO'); ?> <input type="radio" name="mailback" value="0" <?php echo $nochecked ?>/>
					<?php echo BFText::_('YES'); ?> <input type="radio" name="mailback" value="1" <?php echo $yeschecked ?>/>
				</td>
				<td></td>
			</tr>
<?php
...
?>
			<tr>
				<td></td>
				<td nowrap><?php echo BFText::_('ELEMENTS_FIELDSZ'); ?>:</td>
				<td nowrap>
					<input size="6" maxlength="6" name="width" value="<?php echo $row->width; ?>" class="inputbox"/>
					&nbsp;&nbsp;&nbsp;&nbsp;<?php echo BFText::_('ELEMENTS_MAXFILESIZE'); ?>:
...
<?php
					if ($row->type=='Image')
						echo mosToolTip(BFText::_('ELEMENTS_IMAGE0'));
					else
						echo mosToolTip(BFText::_('ELEMENTS_OTHER0'));
?>
				</td>
				<td></td>
			</tr>
...
?>
			<tr>
				...
				<td nowrap>
					...
					&nbsp;&nbsp;&nbsp;&nbsp;<?php echo BFText::_('ELEMENTS_ROWSPERPAGE'); ?>:
			...
			<tr id="pagenavrow"<?php if ($row->height==0) echo ' style="display:none"'; ?>>
				<td></td>
				<td nowrap><?php echo BFText::_('ELEMENTS_PAGENAV'); ?>:</td>
				<td nowrap>
					<select name="pagenav" size="1" class="inputbox">
						<option value="0">none</option>
						<option value="1" selected="selected">&lt;&lt; <?php echo BFText::_('PROCESS_PAGESTART'); ?> &lt; <?php echo BFText::_('PROCESS_PAGEPREV'); ?> 1 2 3 <?php BFText::_('PROCESS_PAGENEXT'); ?> &gt; <?php BFText::_('PROCESS_PAGEEND'); ?> &gt;&gt;</option>
						<option value="2">&lt;&lt; <?php echo BFText::_('PROCESS_PAGESTART'); ?> &lt; <?php echo BFText::_('PROCESS_PAGEPREV'); ?> <?php echo BFText::_('PROCESS_PAGENEXT'); ?> &gt; <?php echo BFText::_('PROCESS_PAGEEND'); ?> &gt;&gt;</option>
...
?>
			<tr>
				<td></td>
				<td nowrap><?php echo BFText::_('ELEMENTS_CHECKED'); ?>:</td>
				<td nowrap><?php echo mosHTML::yesnoRadioList("flag1", "", $row->flag1); ?></td>
				<td></td>
			</tr>
<?php
					break;
...
?>
			<tr>
				<td></td>
				<td nowrap><?php echo BFText::_('ELEMENTS_MULTIPLE'); ?>:</td>
				<td nowrap><?php echo mosHTML::yesnoRadioList("flag1", "", $row->flag1); ?></td>
				<td></td>
			</tr>
<?php
...
?>
			<tr>
				<td></td>
				<td nowrap><?php echo BFText::_('ELEMENTS_SHOWHEADER'); ?>:</td>
				<td nowrap><?php echo mosHTML::yesnoRadioList("flag1", "", $row->flag1); ?></td>
				<td></td>
			</tr>
<?php
...
?>
			<tr>
				<td></td>
				<td nowrap><?php echo BFText::_('ELEMENTS_PASSWORD'); ?>:</td>
				<td nowrap><?php echo mosHTML::yesnoRadioList("flag1", "", $row->flag1); ?></td>
				<td></td>
			</tr>
<?php
...
?>
			<tr>
				<td></td>
				<td nowrap><?php echo BFText::_('ELEMENTS_UPLDTIMESTAMP'); ?>:</td>
				<td nowrap><?php echo mosHTML::yesnoRadioList("flag1", "", $row->flag1); ?></td>
				<td></td>
			</tr>
<?php
...
?>
			<tr>
				<td></td>
				<td nowrap><?php echo BFText::_('ELEMENTS_TYPE'); ?>:</td>
				<td nowrap>
					<input type="radio" id="flag10" name="flag1" value="0"<?php if ($row->flag1==0) echo ' checked="checked"'; ?> onclick="disptooltipurl(this.value)"/><label for="flag10"> <img src="<?php echo $ff_mossite; ?>/includes/js/ThemeOffice/tooltip.png" alt="" border="0"/></label>&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="radio" id="flag11" name="flag1" value="1"<?php if ($row->flag1==1) echo ' checked="checked"'; ?> onclick="disptooltipurl(this.value)"/><label for="flag11"> <img src="<?php echo $ff_mossite; ?>/includes/js/ThemeOffice/warning.png" alt="" border="0"/></label>&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="radio" id="flag12" name="flag1" value="2"<?php if ($row->flag1==2) echo ' checked="checked"'; ?> onclick="disptooltipurl(this.value)"/><label for="flag12"> <?php echo BFText::_('ELEMENTS_CUSTOM'); ?></label>
				<td></td>
			</tr>
<?php
				default:
			...
			<tr>
				...
				<td nowrap>
					<select name="flag2" size="1" class="inputbox">
						<option value="0"<?php if ($row->flag2==0) echo ' selected="selected"'; ?>><?php echo BFText::_('ELEMENTS_ENABLED'); ?></option>
						<option value="1"<?php if ($row->flag2==1) echo ' selected="selected"'; ?>><?php echo BFText::_('ELEMENTS_DISABLED'); ?></option>
					</select>
				<td></td>
			</tr>
<?php
...
?>
			<tr>
				<td></td>
				<td nowrap><?php echo BFText::_('ELEMENTS_BORDER'); ?>:</td>
				<td nowrap><?php echo mosHTML::yesnoRadioList("flag2", "", $row->flag2); ?></td>
				<td></td>
			</tr>
<?php
					break;
			...
			<tr>
				...
				<td nowrap>
					<select name="flag2" size="1" class="inputbox">
						<option value="0"<?php if ($row->flag2==0) echo ' selected="selected"'; ?>><?php echo BFText::_('ELEMENTS_ENABLED'); ?></option>
						<option value="1"<?php if ($row->flag2==1) echo ' selected="selected"'; ?>><?php echo BFText::_('ELEMENTS_DISABLED'); ?></option>
						<option value="2"<?php if ($row->flag2==2) echo ' selected="selected"'; ?>><?php echo BFText::_('ELEMENTS_READONLY'); ?></option>
					</select>
				<td></td>
			</tr>
<?php
...
?>
			<tr>
				<td></td>
				<td nowrap><?php echo BFText::_('ELEMENTS_FIRSTCOLUMN'); ?>:</td>
				<td nowrap>
					<select name="flag2" size="1" class="inputbox">
						<option value="0"<?php if ($row->flag2==0) echo ' selected="selected"'; ?>><?php echo BFText::_('ELEMENTS_NORMAL'); ?></option>
						<option value="1"<?php if ($row->flag2==1) echo ' selected="selected"'; ?>><?php echo BFText::_('ELEMENTS_CHECKBOXES'); ?></option>
						<option value="2"<?php if ($row->flag2==2) echo ' selected="selected"'; ?>><?php echo BFText::_('ELEMENTS_RADIOBUTTONS'); ?></option>
					</select>
				</td>
				<td></td>
			</tr>
...
?>
			<tr>
				<td></td>
				<td nowrap colspan="2">
					<?php echo BFText::_('ELEMENTS_UPLDIR'); ?>:
...
?>
			<tr>
				<td></td>
				<td nowrap colspan="2">
					<?php echo BFText::_('ELEMENTS_TEXTHTML'); ?>:
<?php
						if ($ff_config->wysiwyg) {
							echo '<br/>';
							editorArea('editor1', $row->data1, 'data1', '500', '300', '45', '10');
						} else {
...
?>
			<tr>
				<td></td>
				<td nowrap colspan="2">
					<?php echo BFText::_('ELEMENTS_BORDER'); ?>:
					<a href="#" onClick="textAreaResize('data1',<?php echo $ff_config->areasmall; ?>);">[<?php echo $ff_config->areasmall; ?>]</a>
					<a href="#" onClick="textAreaResize('data1',<?php echo $ff_config->areamedium; ?>);">[<?php echo $ff_config->areamedium; ?>]</a>
					<a href="#" onClick="textAreaResize('data1',<?php echo $ff_config->arealarge; ?>);">[<?php echo $ff_config->arealarge; ?>]</a>
					<br/>
...
?>
			<tr>
				<td></td>
				<td nowrap colspan="2">
					<?php echo BFText::_('ELEMENTS_IMGURL'); ?>:
					<a href="#" onClick="textAreaResize('data1',<?php echo $ff_config->areasmall; ?>);">[<?php echo $ff_config->areasmall; ?>]</a>
					<a href="#" onClick="textAreaResize('data1',<?php echo $ff_config->areamedium; ?>);">[<?php echo $ff_config->areamedium; ?>]</a>
					<a href="#" onClick="textAreaResize('data1',<?php echo $ff_config->arealarge; ?>);">[<?php echo $ff_config->arealarge; ?>]</a>
					<br/>
...
?>
			<tr>
				<td></td>
				<td nowrap colspan="2">
					<?php echo BFText::_('ELEMENTS_SIZE'); ?>:
					<a href="#" onClick="textAreaResize('data1',<?php echo $ff_config->areasmall; ?>);">[<?php echo $ff_config->areasmall; ?>]</a>
					<a href="#" onClick="textAreaResize('data1',<?php echo $ff_config->areamedium; ?>);">[<?php echo $ff_config->areamedium; ?>]</a>
					<a href="#" onClick="textAreaResize('data1',<?php echo $ff_config->arealarge; ?>);">[<?php echo $ff_config->arealarge; ?>]</a>
					<br/>
...
?>
			<tr>
				<td></td>
				<td nowrap><?php echo BFText::_('ELEMENTS_BORDERWIDTH'); ?>:</td>
				<td nowrap>
					<input size="3" maxlength="2" name="border" class="inputbox"/>
					&nbsp;&nbsp;&nbsp;&nbsp;<?php echo BFText::_('ELEMENTS_CELLSPACING'); ?>:
					<input size="3" maxlength="2" name="cellspacing" class="inputbox"/>
					&nbsp;&nbsp;&nbsp;&nbsp;<?php echo BFText::_('ELEMENTS_CELLPADDING'); ?>:
...
?>
			<tr>
				<td></td>
				<td nowrap colspan="2">
					<?php echo BFText::_('ELEMENTS_IMGURLF2'); ?>:
...
?>
			<tr>
				<td></td>
				<td nowrap colspan="2">
					<?php echo BFText::_('ELEMENTS_MIMETYPES'); ?>:
...
?>
			<tr>
				<td></td>
				<td colspan="2">
					<fieldset><legend><?php echo BFText::_('ELEMENTS_CAPTION'); ?></legend>
						<table cellpadding="4" cellspacing="1" border="0">
							<tr>
								<td nowrap><?php echo BFText::_('ELEMENTS_TYPE'); ?>:</td>
								<td nowrap>
									<input type="radio" id="flag10" name="flag1" value="0"<?php if ($row->flag1==0) echo ' checked="checked"'; ?> onclick="dispcaptiontext(this.value)"/><label for="flag10"> <?php echo BFText::_('ELEMENTS_NONE'); ?></label>
									<input type="radio" id="flag11" name="flag1" value="1"<?php if ($row->flag1==1) echo ' checked="checked"'; ?> onclick="dispcaptiontext(this.value)"/><label for="flag11"> <?php echo BFText::_('ELEMENTS_BELOW'); ?></label>
									<input type="radio" id="flag12" name="flag1" value="2"<?php if ($row->flag1==2) echo ' checked="checked"'; ?> onclick="dispcaptiontext(this.value)"/><label for="flag12"> <?php echo BFText::_('ELEMENTS_ABOVE'); ?></label>
									<input type="radio" id="flag13" name="flag1" value="3"<?php if ($row->flag1==3) echo ' checked="checked"'; ?> onclick="dispcaptiontext(this.value)"/><label for="flag13"> <?php echo BFText::_('ELEMENTS_LEFT'); ?></label>
									<input type="radio" id="flag14" name="flag1" value="4"<?php if ($row->flag1==4) echo ' checked="checked"'; ?> onclick="dispcaptiontext(this.value)"/><label for="flag14"> <?php echo BFText::_('ELEMENTS_RIGHT'); ?></label>
								</td>
							</tr>
							<tr id="captiontext" style="display:none;">
								<td nowrap colspan="2">
									<?php echo BFText::_('ELEMENTS_TEXT'); ?>:
									<a href="#" onClick="textAreaResize('data2',<?php echo $ff_config->areasmall; ?>);">[<?php echo $ff_config->areasmall; ?>]</a>
									<a href="#" onClick="textAreaResize('data2',<?php echo $ff_config->areamedium; ?>);">[<?php echo $ff_config->areamedium; ?>]</a>
									<a href="#" onClick="textAreaResize('data2',<?php echo $ff_config->arealarge; ?>);">[<?php echo $ff_config->arealarge; ?>]</a>
									<br/>
...
?>
			<tr>
				<td></td>
				<td nowrap colspan="2">
					<?php echo BFText::_('ELEMENTS_CAPTION'); ?>:
					<a href="#" onClick="textAreaResize('data2',<?php echo $ff_config->areasmall; ?>);">[<?php echo $ff_config->areasmall; ?>]</a>
					<a href="#" onClick="textAreaResize('data2',<?php echo $ff_config->areamedium; ?>);">[<?php echo $ff_config->areamedium; ?>]</a>
					<a href="#" onClick="textAreaResize('data2',<?php echo $ff_config->arealarge; ?>);">[<?php echo $ff_config->arealarge; ?>]</a>
					<br/>
...
?>
			<tr>
				<td></td>
				<td nowrap colspan="2">
					<?php echo BFText::_('ELEMENTS_LABEL'); ?>:
					<a href="#" onClick="textAreaResize('data2',<?php echo $ff_config->areasmall; ?>);">[<?php echo $ff_config->areasmall; ?>]</a>
					<a href="#" onClick="textAreaResize('data2',<?php echo $ff_config->areamedium; ?>);">[<?php echo $ff_config->areamedium; ?>]</a>
					<a href="#" onClick="textAreaResize('data2',<?php echo $ff_config->arealarge; ?>);">[<?php echo $ff_config->arealarge; ?>]</a>
					<br/>
...
?>
			<tr>
				<td></td>
				<td nowrap colspan="2">
					<?php echo BFText::_('ELEMENTS_BKGCOLOR'); ?>:
					<a href="#" onClick="textAreaResize('data2',<?php echo $ff_config->areasmall; ?>);">[<?php echo $ff_config->areasmall; ?>]</a>
					<a href="#" onClick="textAreaResize('data2',<?php echo $ff_config->areamedium; ?>);">[<?php echo $ff_config->areamedium; ?>]</a>
					<a href="#" onClick="textAreaResize('data2',<?php echo $ff_config->arealarge; ?>);">[<?php echo $ff_config->arealarge; ?>]</a>
					<br/>
...
?>
			<tr>
				<td></td>
				<td nowrap colspan="2">
					<?php echo BFText::_('ELEMENTS_ALTTEXT'); ?>:
					<a href="#" onClick="textAreaResize('data2',<?php echo $ff_config->areasmall; ?>);">[<?php echo $ff_config->areasmall; ?>]</a>
					<a href="#" onClick="textAreaResize('data2',<?php echo $ff_config->areamedium; ?>);">[<?php echo $ff_config->areamedium; ?>]</a>
					<a href="#" onClick="textAreaResize('data2',<?php echo $ff_config->arealarge; ?>);">[<?php echo $ff_config->arealarge; ?>]</a>
					<br/>
...
?>
			<tr>
				<td></td>
				<td nowrap colspan="2">
					<?php echo BFText::_('ELEMENTS_OPTIONS'); ?>:
					<a href="#" onClick="textAreaResize('data2',<?php echo $ff_config->areasmall; ?>);">[<?php echo $ff_config->areasmall; ?>]</a>
					<a href="#" onClick="textAreaResize('data2',<?php echo $ff_config->areamedium; ?>);">[<?php echo $ff_config->areamedium; ?>]</a>
					<a href="#" onClick="textAreaResize('data2',<?php echo $ff_config->arealarge; ?>);">[<?php echo $ff_config->arealarge; ?>]</a>
					<a href="#" onClick="addOption();"><?php echo BFText::_('ELEMENTS_ADDOPTIONS'); ?></a>
					<br/>
					<textarea wrap="off" name="data2" style="width:700px;" rows="<?php echo $ff_config->areasmall; ?>" class="inputbox"><?php echo htmlspecialchars($row->data2, ENT_QUOTES); ?></textarea>
<?php
					echo mosToolTip(BFText::_('ELEMENTS_OPTINFO'));
?>
				</td>
				<td></td>
			</tr>
...
<?php
		if ($row->type == 'Query List') {
			$tabs->endTab();
			$tabs->startTab(BFText::_('ELEMENTS_QUERY'),"tab_query");
?>
		<table class="adminform">
			<tr>
				<td></td>
				<td nowrap colspan="2">
					...
					<a href="#" onClick="createQueryCode();"><?php echo BFText::_('ELEMENTS_CREATEQUERY'); ?></a>
					<?php  echo mosToolTip(BFText::_('ELEMENTS_TIPQUERY')); ?>
					<br />
...
<?php
			$tabs->endTab();
			$tabs->startTab(BFText::_('ELEMENTS_QUERYCOLS'),"tab_querycols");
?>
			...
			<tr>
				...
				<td nowrap colspan="2">
					<div style="text-align:right;">
						<input type="button" value="<?php echo BFText::_('TOOLBAR_NEW'); ?>" onclick="qcolAdd()" class="button"/>
						<input type="button" value="<?php echo BFText::_('TOOLBAR_COPY'); ?>" onclick="qcolCopy()" class="button"/>
						<input type="button" value="<?php echo BFText::_('TOOLBAR_DELETE'); ?>" onclick="qcolDelete()" class="button"/>
					</div><br/>
					<table id="qcolTable" width="100%" class="adminlist">
						<tr>
							...
							<th width="100%" valign="top" align="left"><?php echo BFText::_('ELEMENTS_TITLE'); ?></th>
							<th nowrap valign="top" align="left"><?php echo BFText::_('ELEMENTS_NAME'); ?></th>
							<th nowrap valign="top" align="left"><?php echo BFText::_('ELEMENTS_HEADER').' '.BFText::_('ELEMENTS_ATTRIBUTES'); ?></th>
							<th nowrap valign="top" align="left"><?php echo BFText::_('ELEMENTS_DATA').' '.BFText::_('ELEMENTS_ATTRIBUTES'); ?></th>
							<th nowrap valign="top" align="left"><?php echo BFText::_('ELEMENTS_WIDTH'); ?></th>
							<th nowrap valign="top" align="center" colspan="2"><?php echo BFText::_('ELEMENTS_REORDER'); ?></th>
						</tr>
					</table>
				</td>
				<td></td>
...
<?php
		...
		if ($hasInit || $hasAction || $hasValidation) {
			$tabs->endTab();
			$tabs->startTab(BFText::_('ELEMENTS_SCRIPTS'),"tab_scripts");
?>
		<table class="adminform">
<?php
			if ($hasInit) {
?>
			<tr>
				<td></td>
				<td colspan="2">
					<fieldset><legend><?php echo BFText::_('ELEMENTS_INITSCRIPT'); ?></legend>
						<table cellpadding="4" cellspacing="1" border="0">
							<tr>
								<td nowrap><?php echo BFText::_('ELEMENTS_TYPE'); ?>:</td>
								<td nowrap>
									<input type="radio" id="script1cond1" name="script1cond" value="0" onclick="dispinit(this.value)"<?php if ($row->script1cond==0) echo ' checked="checked"'; ?> /><label for="script1cond1"> <?php echo BFText::_('ELEMENTS_NONE'); ?></label>
									<input type="radio" id="script1cond2" name="script1cond" value="1" onclick="dispinit(this.value)"<?php if ($row->script1cond==1) echo ' checked="checked"'; ?> /><label for="script1cond2"> <?php echo BFText::_('ELEMENTS_LIBRARY'); ?></label>
									<input type="radio" id="script1cond3" name="script1cond" value="2" onclick="dispinit(this.value)"<?php if ($row->script1cond==2) echo ' checked="checked"'; ?> /><label for="script1cond3"> <?php echo BFText::_('ELEMENTS_CUSTOM'); ?></label>
								</td>
								<td></td>
							</tr>
							<tr id="initexec" style="display:none;">
								<td nowrap><?php echo BFText::_('ELEMENTS_CONDITIONS'); ?>:</td>
								<td nowrap>
									<input type="checkbox" id="script1flag1" name="script1flag1" value="1"<?php if ($row->script1flag1==1) echo ' checked="checked"'; ?> /><label for="script1flag1"> <?php echo BFText::_('ELEMENTS_FORMENTRY'); ?></label>
									<input type="checkbox" id="script1flag2" name="script1flag2" value="1"<?php if ($row->script1flag2==1) echo ' checked="checked"'; ?> /><label for="script1flag2"> <?php echo BFText::_('ELEMENTS_PAGEENTRY'); ?></label>
								</td>
								<td></td>
							</tr>
							<tr id="initlib" style="display:none;">
								<td nowrap><?php echo BFText::_('ELEMENTS_SCRIPT'); ?>:</td>
								<td nowrap>
...
?>
							...
							<tr id="initcode" style="display:none;">
								<td nowrap valign="top" colspan="2">
									...
									<a href="#" onClick="createInitCode();"><?php echo BFText::_('ELEMENTS_CREATECODE'); ?></a>
<?php
									echo mosToolTip(BFText::_('ELEMENTS_TIPINIT'))."\n";
?>
									<br />
...
?>
			<tr>
				<td></td>
				<td colspan="2">
					<fieldset><legend><?php echo BFText::_('ELEMENTS_ACTIONSCRIPT'); ?></legend>
						<table cellpadding="4" cellspacing="1" border="0">
							<tr>
								<td nowrap><?php echo BFText::_('ELEMENTS_TYPE'); ?>:</td>
								<td nowrap>
									<input type="radio" id="script2cond1" name="script2cond" value="0" onclick="dispaction(this.value)"<?php if ($row->script2cond==0) echo ' checked="checked"'; ?> /><label for="script2cond1"> <?php echo BFText::_('ELEMENTS_NONE'); ?></label>
									<input type="radio" id="script2cond2" name="script2cond" value="1" onclick="dispaction(this.value)"<?php if ($row->script2cond==1) echo ' checked="checked"'; ?> /><label for="script2cond2"> <?php echo BFText::_('ELEMENTS_LIBRARY'); ?></label>
									<input type="radio" id="script2cond3" name="script2cond" value="2" onclick="dispaction(this.value)"<?php if ($row->script2cond==2) echo ' checked="checked"'; ?> /><label for="script2cond3"> <?php echo BFText::_('ELEMENTS_CUSTOM'); ?></label>
								</td>
								<td></td>
							</tr>
							<tr id="actionact" style="display:none;">
								<td nowrap><?php echo BFText::_('ELEMENTS_ACTIONS'); ?>:</td>
								<td nowrap>
<?php
									switch ($row->type) {
										case 'Regular Button':
										...
										case 'Icon':
?>
									<input type="checkbox" id="script2flag1" name="script2flag1" value="1"<?php if ($row->script2flag1==1) echo ' checked="checked"'; ?>/><label for="script2flag1"> <?php echo BFText::_('ELEMENTS_CLICK'); ?></label>
<?php
											break;
										default:
?>
									<input type="checkbox" id="script2flag1" name="script2flag1" value="1"<?php if ($row->script2flag1==1) echo ' checked="checked"'; ?>/><label for="script2flag1"> <?php echo BFText::_('ELEMENTS_CLICK'); ?></label>
									<input type="checkbox" id="script2flag2" name="script2flag2" value="1"<?php if ($row->script2flag2==1) echo ' checked="checked"'; ?>/><label for="script2flag2"> <?php echo BFText::_('ELEMENTS_BLUR'); ?></label>
									<input type="checkbox" id="script2flag3" name="script2flag3" value="1"<?php if ($row->script2flag3==1) echo ' checked="checked"'; ?>/><label for="script2flag3"> <?php echo BFText::_('ELEMENTS_CHANGE'); ?></label>
									<input type="checkbox" id="script2flag4" name="script2flag4" value="1"<?php if ($row->script2flag4==1) echo ' checked="checked"'; ?>/><label for="script2flag4"> <?php echo BFText::_('ELEMENTS_FOCUS'); ?></label>
									<input type="checkbox" id="script2flag5" name="script2flag5" value="1"<?php if ($row->script2flag5==1) echo ' checked="checked"'; ?>/><label for="script2flag5"> <?php echo BFText::_('ELEMENTS_SELECTION'); ?></label>
<?php
											break;
									} // switch
?>
...
?>
							...
							<tr id="actioncode" style="display:none;">
								<td nowrap valign="top" colspan="2">
									...
									<a href="#" onClick="createActionCode();"><?php echo BFText::_('ELEMENTS_CREATECODE'); ?></a>
<?php
									echo mosToolTip(BFText::_('ELEMENTS_TIPACTION'))."\n";
?>
									<br />
...
?>
			<tr>
				<td></td>
				<td colspan="2">
					<fieldset><legend><?php echo BFText::_('ELEMENTS_VALIDSCRIPT'); ?></legend>
						<table cellpadding="4" cellspacing="1" border="0">
							<tr>
								<td nowrap><?php echo BFText::_('ELEMENTS_TYPE'); ?>:</td>
								<td nowrap>
									<input type="radio" id="script3cond1" name="script3cond" value="0" onclick="dispvalidation(this.value)"<?php if ($row->script3cond==0) echo ' checked="checked"'; ?> /><label for="script3cond1"> <?php echo BFText::_('ELEMENTS_NONE'); ?></label>
									<input type="radio" id="script3cond2" name="script3cond" value="1" onclick="dispvalidation(this.value)"<?php if ($row->script3cond==1) echo ' checked="checked"'; ?> /><label for="script3cond2"> <?php echo BFText::_('ELEMENTS_LIBRARY'); ?></label>
									<input type="radio" id="script3cond3" name="script3cond" value="2" onclick="dispvalidation(this.value)"<?php if ($row->script3cond==2) echo ' checked="checked"'; ?> /><label for="script3cond3"> <?php echo BFText::_('ELEMENTS_CUSTOM'); ?></label>
								</td>
								<td></td>
							</tr>
							<tr id="validationmsg" style="display:none;">
								<td nowrap valign="top"><?php echo BFText::_('ELEMENTS_MESSAGE'); ?>:</td>
								<td nowrap valign="top">
									<input type="text" size="50" maxlength="255" name="script3msg" value="<?php echo $row->script3msg; ?>" class="inputbox"/>
<?php
									echo mosToolTip(BFText::_('ELEMENTS_TIPMESSAGE'))."\n";
?>
								</td>
								<td></td>
							</tr>
...
?>
							...
							<tr id="validationcode" style="display:none;">
								<td nowrap valign="top" colspan="2">
									...
									<a href="#" onClick="createValidationCode();"><?php echo BFText::_('ELEMENTS_CREATECODE'); ?></a>
<?php
									echo mosToolTip(BFText::_('ELEMENTS_TIPVALID'))."\n";
?>
									<br />
...
?>
		...
		<tr>
			...
			<td nowrap style="text-align:right">
				 <input type="submit" onclick="<?php if ($row->type=='Query List') echo "\t\t\t\tsaveQueryList();" ?>document.getElementById('task').value='save';" value="<?php echo BFText::_('TOOLBAR_SAVE'); ?>"/>&nbsp;&nbsp;
				 <input type="submit" onclick="document.getElementById('task').value='cancel';" value="<?php echo BFText::_('TOOLBAR_CANCEL'); ?>"/>
			</td>
			<td></td>
		</tr>
		</table>
			...
			function submitbutton(pressbutton)
			{
				...
				switch (pressbutton) {
					...
					case 'remove':
						if (form.boxchecked.value==0) {
							alert("<?php echo BFText::_('ELEMENTS_SELELEMENTS'); ?>");
							return;
						} // if
						break;
					default:
				...
				switch (pressbutton) {
					case 'share':
						...
						break;
					case 'sort':
						if (!confirm("<?php echo BFText::_('ELEMENTS_ASKSORT'); ?>")) return;
						break;
					case 'remove':
						if (!confirm("<?php echo BFText::_('ELEMENTS_ASKDELELEMENTS'); ?>")) return;
						break;
					case 'delpage':
						if (!confirm("<?php echo BFText::_('ELEMENTS_ASKDELPAGE'); ?>")) return;
						break;
					case 'movepos':
						if (form.movepixels.value=='') {
							alert("<?php echo BFText::_('ELEMENTS_ENTPIXMOVE'); ?>");
							return;
						} // if
						var nonDigits = /\D/;
						if (nonDigits.test(form.movepixels.value)) {
							alert("<?php echo BFText::_('ELEMENTS_PIXMOVEINT'); ?>");
							return;
						} // if
						break;
					default:
			...
			<tr>
				<td nowrap>
					<table class="adminheading">
						<tr><th class="edit" nowrap>BreezingForms <?php echo $ff_version; ?><br/><span class="componentheading"><?php echo $form->title; ?> <?php echo BFText::_('ELEMENTS_PAGE'); ?> <?php echo $page; ?></span></th></tr>
					</table>
				</td>
				<td width="100%" align="right" nowrap>
<?php
		JToolBarHelper::custom('share',  	'upload.png',    'upload_f2.png',    BFText::_('SHARE_FORM'),        false);
		JToolBarHelper::custom('editform',  'edit.png',      'edit_f2.png',      BFText::_('TOOLBAR_EDITFORM'),  false);
		...
		JToolBarHelper::custom('move',      'move.png',      'move_f2.png',      BFText::_('TOOLBAR_MOVE'),      false);
		...
		<form action="index2.php" method="post" name="adminForm" id="adminForm" class="adminForm">
			<table cellpadding="4" cellspacing="0" border="0" width="100%" class="adminlist">
				<tr>
					...
					<th nowrap align="left"><?php echo BFText::_('ELEMENTS_TITLE'); ?></th>
					<th nowrap align="left"><?php echo BFText::_('ELEMENTS_NAME'); ?></th>
					<th nowrap align="left"><?php echo BFText::_('ELEMENTS_TYPE'); ?></th>
					<th nowrap align="center"><?php echo BFText::_('ELEMENTS_PUBLISHED'); ?></th>
					<th nowrap align="center" colspan="2"><a href="#sort" onclick="submitbutton('sort')"><?php echo BFText::_('ELEMENTS_REORDER'); ?></a></th>
					<th nowrap align="center">X</th>
					<th nowrap align="center">Y</th>
					<th nowrap align="center"><?php echo BFText::_('ELEMENTS_SCRIPTID'); ?></th>
					<th width="100%"></th>
				</tr>
<?php
				$k = 0;
...
<?php
						if ($row->published == "1") {
							echo "<a href=\"#unpublish\" onClick=\"return listItemTask('cb".$i."','unpublish')\"><img src=\"images/publish_g.png\" alt=\"+\" border=\"0\" /></a>";
						} else {
							echo "<a href=\"#publish\" onClick=\"return listItemTask('cb".$i."','publish')\"><img src=\"images/publish_x.png\" alt=\"-\" border=\"0\" /></a>";
						} // if
?>
					</td>
...
<?php
						if ($i > 0)
							echo "<a href=\"#orderup\" onClick=\"return listItemTask('cb".$i."','orderup')\"><img src=\"images/uparrow.png\" alt=\"^\" border=\"0\" /></a>";
?>
					</td>
					<td nowrap align="left">
<?php
						if ($i < count($rows)-1)
							echo "<a href=\"#orderdown\" onClick=\"return listItemTask('cb".$i."','orderdown')\"><img src=\"images/downarrow.png\" alt=\"v\" border=\"0\" /></a>";
?>
					</td>
...
?>
			<table cellpadding="4" cellspacing="1" border="0" class="adminform" style="width:300px;">
				<tr><th colspan="2" class="title">BreezingForms - <?php echo BFText::_('ELEMENTS_PAGELAY'); ?></th></tr>
				<tr>
					<td colspan="2">
						<table class="menubar" cellpadding="3" cellspacing="0" border="0">
							<tr><td nowrap class="menudottedline" align="right">
								<a class="toolbar" href="javascript:submitbutton('addbefore');" onmouseout="MM_swapImgRestore();"  onmouseover="MM_swapImage('addbefore','','images/new_f2.png',1);"><img src="images/new.png"  alt="" name="addbefore" border="0" align="middle" />&nbsp;<?php echo BFText::_('ELEMENTS_ADDPAGEBEFORE'); ?></a>
								&nbsp;&nbsp;<a class="toolbar" href="javascript:submitbutton('addbehind');" onmouseout="MM_swapImgRestore();"  onmouseover="MM_swapImage('addbehind','','images/new_f2.png',1);"><img src="images/new.png" alt="" name="addbehind" border="0" align="middle" />&nbsp;<?php echo BFText::_('ELEMENTS_ADDPAGEBEHIND'); ?></a>
<?php
								if ($form->pages > 1) {
?>
									&nbsp;&nbsp;<a class="toolbar" href="javascript:submitbutton('movepage');" onmouseout="MM_swapImgRestore();"  onmouseover="MM_swapImage('movepage','','images/move_f2.png',1);"><img src="images/move.png"  alt="" name="movepage" border="0" align="middle" />&nbsp;<?php echo BFText::_('ELEMENTS_MOVEPG'); ?></a>
									&nbsp;&nbsp;<a class="toolbar" href="javascript:submitbutton('delpage');" onmouseout="MM_swapImgRestore();"  onmouseover="MM_swapImage('delpage','','images/delete_f2.png',1);"><img src="images/delete.png"  alt="" name="delpage" border="0" align="middle" />&nbsp;<?php echo BFText::_('ELEMENTS_DELPAGE'); ?></a>
<?php
								} // if
?>
							</td></tr>
						...
						<table class="menubar" cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td nowrap colspan="5" style="text-align:center">
								    ...
								    if ($form->prevmode == 2) {
								    ?>
									    <?php echo BFText::_('DRAGGING') ?> <br/> <?php echo BFText::_('DRAGGING_ON') ?> <input type="radio" id="draggingEnabled" name="dragToggle" onclick="dd.elements.SelectOptionDialog.setDraggable(true);"/> <?php echo BFText::_('DRAGGING_OFF') ?> <input id="draggingDisabled" checked type="radio" name="dragToggle" onclick="dd.elements.SelectOptionDialog.setDraggable(false);"/>
										<br/>
									<?php
									}
									?>
									<input type="checkbox" id="gridshow" name="gridshow" onclick="submitbutton('gridshow');" value="1"<?php if ($ff_config->gridshow==1) echo ' checked="checked"'; ?> /><label for="gridshow"> <?php echo BFText::_('ELEMENTS_GRID'); ?></label>
									<br/><hr/>
								</td>
							</tr>
							<tr>
								<td nowrap colspan="5" style="text-align:center">
									<?php echo BFText::_('ELEMENTS_MOVEPIX'); ?>:<br/>
							...
							<tr>
								<td colspan="5" style="text-align:center">
									<input id="savepos" type="button" value="<?php echo BFText::_('ELEMENTS_SAVE'); ?>" onclick="savePositions();" disabled="disabled"/><br/>
									<input id="restpos" type="button" value="<?php echo BFText::_('ELEMENTS_RESTORE'); ?>" onclick="restorePositions();" disabled="disabled"/>
									<hr/>
								</td>
							</tr>
							<tr>
...
<?php
							for ($p = 1; $p <= $form->pages; $p++) {
								...
								echo '<input type="button" value="'.BFText::_('ELEMENTS_PAGE').' '.$p.'" onclick="changepage(\''.$p.'\');" '.$attribute.'/><br/>';
							} // for
?>
								</td>
							</tr>
...
?>
						<iframe <?php echo $params; ?>>
							<p><?php echo BFText::_('ELEMENTS_BROWSER1'); ?></p>
							<p><?php echo BFText::_('ELEMENTS_BROWSER2'); ?></p>
						</iframe>
<?php
						} else {
							$tstyle = ' style="';
...
<?php
	...
	{
		if ($action == 'copysave')
			$title = BFText::_('ELEMENTS_COPY');
		else
			$title = BFText::_('ELEMENTS_MOVE');
?>
		<script type="text/javascript">
		<!--
		function submitbutton(pressbutton) {
			...
			if (!getSelectedValue('adminForm', 'destination')) {
				alert( "<?php echo BFText::_('ELEMENTS_SELFORMPAGE'); ?>" );
			} else {
				submitform( pressbutton );
			} // if
		} // submitbutton
		...
		<table cellpadding="4" cellspacing="1" border="0" class="adminform" style="width:300px;">
			...
			<tr>
				...
				<td style="text-align:center"  valign="top">
					<strong><?php echo BFText::_('ELEMENTS_TOFORMPAGE'); ?>:</strong>
			...
			<tr>
				<td></td>
				<td nowrap style="text-align:right">
					<a class="toolbar" href="javascript:submitbutton('<?php echo $action; ?>');" onmouseout="MM_swapImgRestore();"  onmouseover="MM_swapImage('next','','images/next_f2.png',1);">
						<img src="images/next.png" alt="" name="next" border="0" align="middle" />&nbsp;<?php echo BFText::_('TOOLBAR_CONTINUE'); ?>
					</a>&nbsp;&nbsp;
					<a class="toolbar" href="javascript:submitbutton('cancel');" onmouseout="MM_swapImgRestore();"  onmouseover="MM_swapImage('cancel','','images/cancel_f2.png',1);">
						<img src="images/cancel.png" alt="" name="cancel" border="0" align="middle" />&nbsp;<?php echo BFText::_('TOOLBAR_CANCEL'); ?>
...
?>
		...
		function submitbutton(pressbutton) {
			...
			// do field validation
			if (!getSelectedValue('adminForm', 'destination')) {
				alert( "<?php echo BFText::_('ELEMENTS_SELPAGEMOVE'); ?>" );
			} else {
				submitform( pressbutton );
			} // if
		} // submitbutton
		...
		<form action="index2.php" method="post" name="adminForm" id="adminForm" class="adminForm">
		<table cellpadding="4" cellspacing="1" border="0" class="adminform" style="width:300px;">
			<tr><th colspan="3" class="title">FacileForms - <?php echo BFText::_('ELEMENTS_MOVEPAGE'); ?></th></tr>
			<tr>
				<td></td>
				<td style="text-align:center" valign="top">
					<strong><?php echo BFText::_('ELEMENTS_SELNRPAGE'); ?>:</strong>
					<br/><br/><?php echo $sellist; ?><br /><br />
				</td>
				<td></td>
			</tr>
			<tr>
				<td></td>
				<td nowrap style="text-align:right">
					<a class="toolbar" href="javascript:submitbutton('movepagesave');" onmouseout="MM_swapImgRestore();"  onmouseover="MM_swapImage('next','','images/next_f2.png',1);">
						<img src="images/next.png" alt="" name="next" border="0" align="middle" />&nbsp;<?php echo BFText::_('TOOLBAR_CONTINUE'); ?>
					</a>&nbsp;&nbsp;
					<a class="toolbar" href="javascript:submitbutton('cancel');" onmouseout="MM_swapImgRestore();"  onmouseover="MM_swapImage('cancel','','images/cancel_f2.png',1);">
						<img src="images/cancel.png" alt="" name="cancel" border="0" align="middle" />&nbsp;<?php echo BFText::_('TOOLBAR_CANCEL'); ?>
