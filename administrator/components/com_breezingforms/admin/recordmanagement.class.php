...
class bfRecordManagement
{
	...
	{
		JToolBarHelper::custom('exportPdf',    'ff_download',             'ff_download_f2',             BFText::_('PDF'),    false);
		JToolBarHelper::custom('exportCsv',    'ff_download',             'ff_download_f2',             BFText::_('CSV'),    false);
		JToolBarHelper::custom('exportXml',    'ff_download',             'ff_download_f2',             BFText::_('XML'),    false);
		JToolBarHelper::custom('remove',    'delete.png',       'delete_f2.png',    BFText::_('TOOLBAR_DELETE'),    false);
		JToolBarHelper::custom('all',    'ff_switch',             'ff_switch_f2',             BFText::_('ALL'),    false);
		JToolBarHelper::custom('viewed',    'ff_switch',             'ff_switch_f2',             BFText::_('TOOLBAR_VIEWED'),    false);
		JToolBarHelper::custom('exported',  'ff_switch',             'ff_switch_f2',             BFText::_('TOOLBAR_EXPORTED'),  false);
		JToolBarHelper::custom('archived',  'ff_switch',             'ff_switch_f2',             BFText::_('TOOLBAR_ARCHIVED'),  false);
		...
		$this->recordsHtml($rows, $pagination, $formsArray);
	}
	...
	function expxml($ids)
	{
		...
		if (!JFile::write($xmlname,$xml)) {
			echo "<script> alert('".addslashes(BFText::_('RECORDS_XMLNORWRTBL'))."'); window.history.go(-1);</script>\n";
			exit();
		} // if
	...
	{
		$this->db->setQuery(
				"select Distinct * from #__facileforms_subrecords where record = ".intval($recordId)." order by title"
			);
...
<?
        ...
        function recordHtml(stdClass $rec, array $subs)
	{
?>
<div id="overDiv" style="position:absolute; visibility:hidden; z-index:10000;"></div>
		...
		<table cellpadding="0" cellspacing="0" border="0" class="adminform" style="width:100%;">
			<tr><th colspan="4" class="title">BreezingForms - <?php echo BFText::_('RECORDS_VIEWRECORD'); ?></th></tr>
			<tr>
				<td></td>
				<td colspan="2">
					<fieldset><legend><?php echo BFText::_('RECORDS_SUBMINFO'); ?></legend>
						<table cellpadding="0" cellspacing="0" border="1">
							<tr>
								<td nowrap><strong><?php echo BFText::_('RECORDS_SUBMITTED'); ?></strong></td>
								<td nowrap><strong>IP</strong></td>
								<td nowrap><strong><?php echo BFText::_('RECORDS_PROVIDER'); ?></strong></td>
								<td nowrap><strong><?php echo BFText::_('RECORDS_OPSYS'); ?></strong></td>
								<td nowrap><strong><?php echo BFText::_('RECORDS_BROWSER'); ?></strong></td>
							</tr>
							<tr>
			...
			<tr>
				<td></td>
				<td colspan="2">
					<fieldset><legend><?php echo BFText::_('Payment Information'); ?></legend>
						<table cellpadding="0" cellspacing="0" border="1">
							<tr>
								<td nowrap><strong><?php echo BFText::_('Transaction ID'); ?></strong></td>
								<td nowrap><strong><?php echo BFText::_('Transaction Date'); ?></strong></td>
								<td nowrap><strong><?php echo BFText::_('Test-Account'); ?></strong></td>
								<td nowrap><strong><?php echo BFText::_('Download tries'); ?></strong></td>
							</tr>
							<tr>
								<td nowrap valign="top"><?php echo $rec->paypal_tx_id; ?></td>
								<td nowrap valign="top"><?php echo $rec->paypal_payment_date ?></td>
								<td nowrap valign="top"><?php echo $rec->paypal_testaccount ? BFText::_('YES') : BFText::_('NO'); ?></td>
			...
			<tr>
				<td></td>
				<td>
					<fieldset><legend><?php echo BFText::_('RECORDS_RECORDINFO'); ?></legend>
						<table cellpadding="0" cellspacing="0" border="1">
							<tr>
								<td nowrap><strong>ID</strong></td>
								<td nowrap><strong><?php echo BFText::_('RECORDS_VIEWED'); ?></strong></td>
								<td nowrap><strong><?php echo BFText::_('RECORDS_EXPORTED'); ?></strong></td>
								<td nowrap><strong><?php echo BFText::_('RECORDS_ARCHIVED'); ?></strong></td>
							</tr>
							<tr>
								<td nowrap><?php echo $rec->id; ?></td>
								<td nowrap><?php if ($rec->viewed) echo BFText::_('RECORDS_YES'); else echo BFText::_('RECORDS_NO'); ?></td>
								<td nowrap><?php if ($rec->exported) echo BFText::_('RECORDS_YES'); else echo BFText::_('RECORDS_NO'); ?></td>
								<td nowrap><?php if ($rec->archived) echo BFText::_('RECORDS_YES'); else echo BFText::_('RECORDS_NO'); ?></td>
							</tr>
						</table>
					</fieldset>
				</td>
				<td>
					<fieldset><legend><?php echo BFText::_('RECORDS_FORMINFO'); ?></legend>
						<table cellpadding="0" cellspacing="0" border="1">
							<tr>
								<td nowrap><strong>ID</strong></td>
								<td nowrap><strong><?php echo BFText::_('RECORDS_TITLE'); ?></strong></td>
								<td nowrap><strong><?php echo BFText::_('RECORDS_NAME'); ?></strong></td>
							</tr>
							<tr>
			...
			<tr>
				<td></td>
				<td colspan="2">
					<fieldset><legend><?php echo BFText::_('RECORDS_SUBMVALUES'); ?></legend>
						<table cellpadding="0" cellspacing="0" border="1">
							<tr>
								<td nowrap><strong><?php echo BFText::_('RECORDS_RECORDID'); ?></strong></td>
								<td nowrap><strong><?php echo BFText::_('RECORDS_ELEMENTID'); ?></strong></td>
								<td nowrap><strong><?php echo BFText::_('RECORDS_TITLE'); ?></strong></td>
								<td nowrap><strong><?php echo BFText::_('RECORDS_NAME'); ?></strong></td>
								<td nowrap><strong><?php echo BFText::_('RECORDS_TYPE'); ?></strong></td>
								<td nowrap><strong><?php echo BFText::_('RECORDS_VALUE'); ?></strong></td>
								<td nowrap><strong><?php echo BFText::_('EDIT'); ?></strong></td>
							</tr>
<?php
			...
			<tr>
				...
				<td colspan="2" style="text-align:right">
					<a class="toolbar" href="javascript:submitbutton('save');">
						<img src="images/save_f2.png"  alt="" name="save" border="0" align="middle" />&nbsp;<?php echo BFText::_('TOOLBAR_SAVE'); ?>
					</a>&nbsp;&nbsp;
					<a class="toolbar" href="javascript:submitbutton('cancel');">
						<img src="images/cancel_f2.png"  alt="" name="cancel" border="0" align="middle" />&nbsp;<?php echo BFText::_('TOOLBAR_CANCEL'); ?>
					</a>
				</td>
				<td></td>
			</tr>
...
<?php
        ...
        function recordsHtml(array $rows, JPagination $pagination, array $forms)
	{
?>
<script type="text/javascript">
function submitbutton(pressbutton)
			{
				...
				switch (pressbutton) {
					...
					case 'exportXml':
						if (form.boxchecked.value==0) {
							alert("<?php echo BFText::_('RECORDS_PLSSELECTRECS'); ?>");
							return;
						} // if
				...
				switch (pressbutton) {
					case 'remove':
						if (!confirm("<?php echo BFText::_('RECORDS_ASKDELETE'); ?>")) return;
						break;
					default:
						break;
				} // switch
...
<div id="editcell">
    ...
    <thead>
    			...
    			<table class="adminlist" width="100%">
	    			...
	    			<tr>
	    				<td>
			    			...
			    			<?php echo BFText::_('TEXT'); ?>: <input type="checkbox" name="txtsearch" onclick="form.status_update.value = 1;document.adminForm.submit()" value="true"<?php echo JRequest::getWord('txtsearch','false') == 'true' ? ' checked="checked"' : ''; ?>/>
			    			<select name="form" onchange="form.status_update.value = 1;document.adminForm.submit()">
			    				<option value=""><?php echo BFText::_('ALL'); ?></option>
			    				<?php
						...
						<td align="right" valign="top">
			    			<?php echo BFText::_('Write Status'); ?>: <input type="radio" name="write_status" value=""<?php echo JRequest::getVar('write_status','') == '' ? ' checked="checked"' : ''; ?>/>  <?php echo BFText::_('none'); ?> <input type="radio" name="write_status" value="unset"<?php echo JRequest::getVar('write_status','') == 'unset' ? ' checked="checked"' : ''; ?>/> <?php echo BFText::_('unset'); ?> <input type="radio" name="write_status" value="set"<?php echo JRequest::getVar('write_status','') == 'set' ? ' checked="checked"' : ''; ?>/> <?php echo BFText::_('set'); ?>
			    		</td>
					</tr>
					</thead>
				</table>
        ...
        <tr>
            ...
            <th>
                <a href="index.php?option=com_breezingforms&amp;act=recordmanagement&amp;txtsearch=<?php echo JRequest::getWord('txtsearch','false'); ?>&amp;search=<?php echo htmlentities(JRequest::getVar('search',''), ENT_QUOTES, 'UTF-8'); ?>&amp;form=<?php echo htmlentities(JRequest::getVar('form',''), ENT_QUOTES, 'UTF-8'); ?>&amp;task=<?php echo JRequest::getVar('task',''); ?>&amp;limitstart=<?php echo JRequest::getInt('limitstart',0); ?>&amp;mylimit=<?php echo JRequest::getInt('mylimit',20); ?>&amp;order=<?php echo JRequest::getVar('order', 'DESC') == 'DESC' ? 'ASC' : 'DESC'; ?>&amp;orderBy=id"><?php echo BFText::_( 'ID' ); ?></a>
            </th>
            <th>
                <a href="index.php?option=com_breezingforms&amp;act=recordmanagement&amp;txtsearch=<?php echo JRequest::getWord('txtsearch','false'); ?>&amp;search=<?php echo htmlentities(JRequest::getVar('search',''), ENT_QUOTES, 'UTF-8'); ?>&amp;form=<?php echo htmlentities(JRequest::getVar('form',''), ENT_QUOTES, 'UTF-8'); ?>&amp;task=<?php echo JRequest::getVar('task',''); ?>&amp;limitstart=<?php echo JRequest::getInt('limitstart',0); ?>&amp;mylimit=<?php echo JRequest::getInt('mylimit',20); ?>&amp;order=<?php echo JRequest::getVar('order', 'DESC') == 'DESC' ? 'ASC' : 'DESC'; ?>&amp;orderBy=submitted"><?php echo BFText::_( 'RECORDS_SUBMITTED' ); ?></a>
            </th>
            <th>
                <a href="index.php?option=com_breezingforms&amp;act=recordmanagement&amp;txtsearch=<?php echo JRequest::getWord('txtsearch','false'); ?>&amp;search=<?php echo htmlentities(JRequest::getVar('search',''), ENT_QUOTES, 'UTF-8'); ?>&amp;form=<?php echo htmlentities(JRequest::getVar('form',''), ENT_QUOTES, 'UTF-8'); ?>&amp;task=<?php echo JRequest::getVar('task',''); ?>&amp;limitstart=<?php echo JRequest::getInt('limitstart',0); ?>&amp;mylimit=<?php echo JRequest::getInt('mylimit',20); ?>&amp;order=<?php echo JRequest::getVar('order', 'DESC') == 'DESC' ? 'ASC' : 'DESC'; ?>&amp;orderBy=ip"><?php echo BFText::_( 'IP' ); ?></a>
            </th>
            <th>
                <a href="index.php?option=com_breezingforms&amp;act=recordmanagement&amp;txtsearch=<?php echo JRequest::getWord('txtsearch','false'); ?>&amp;search=<?php echo htmlentities(JRequest::getVar('search',''), ENT_QUOTES, 'UTF-8'); ?>&amp;form=<?php echo htmlentities(JRequest::getVar('form',''), ENT_QUOTES, 'UTF-8'); ?>&amp;task=<?php echo JRequest::getVar('task',''); ?>&amp;limitstart=<?php echo JRequest::getInt('limitstart',0); ?>&amp;mylimit=<?php echo JRequest::getInt('mylimit',20); ?>&amp;order=<?php echo JRequest::getVar('order', 'DESC') == 'DESC' ? 'ASC' : 'DESC'; ?>&amp;orderBy=provider"><?php echo BFText::_( 'RECORDS_PROVIDER' ); ?></a>
            </th>
            <th>
                <a href="index.php?option=com_breezingforms&amp;act=recordmanagement&amp;txtsearch=<?php echo JRequest::getWord('txtsearch','false'); ?>&amp;search=<?php echo htmlentities(JRequest::getVar('search',''), ENT_QUOTES, 'UTF-8'); ?>&amp;form=<?php echo htmlentities(JRequest::getVar('form',''), ENT_QUOTES, 'UTF-8'); ?>&amp;task=<?php echo JRequest::getVar('task',''); ?>&amp;limitstart=<?php echo JRequest::getInt('limitstart',0); ?>&amp;mylimit=<?php echo JRequest::getInt('mylimit',20); ?>&amp;order=<?php echo JRequest::getVar('order', 'DESC') == 'DESC' ? 'ASC' : 'DESC'; ?>&amp;orderBy=title"><?php echo BFText::_( 'RECORDS_TITLE' ); ?></a>
            </th>
            <th>
                <a href="index.php?option=com_breezingforms&amp;act=recordmanagement&amp;txtsearch=<?php echo JRequest::getWord('txtsearch','false'); ?>&amp;search=<?php echo htmlentities(JRequest::getVar('search',''), ENT_QUOTES, 'UTF-8'); ?>&amp;form=<?php echo htmlentities(JRequest::getVar('form',''), ENT_QUOTES, 'UTF-8'); ?>&amp;task=<?php echo JRequest::getVar('task',''); ?>&amp;limitstart=<?php echo JRequest::getInt('limitstart',0); ?>&amp;mylimit=<?php echo JRequest::getInt('mylimit',20); ?>&amp;order=<?php echo JRequest::getVar('order', 'DESC') == 'DESC' ? 'ASC' : 'DESC'; ?>&amp;orderBy=name"><?php echo BFText::_( 'RECORDS_NAME' ); ?></a>
            </th>
            <th>
                <a href="index.php?option=com_breezingforms&amp;act=recordmanagement&amp;txtsearch=<?php echo JRequest::getWord('txtsearch','false'); ?>&amp;search=<?php echo htmlentities(JRequest::getVar('search',''), ENT_QUOTES, 'UTF-8'); ?>&amp;form=<?php echo htmlentities(JRequest::getVar('form',''), ENT_QUOTES, 'UTF-8'); ?>&amp;task=<?php echo JRequest::getVar('task',''); ?>&amp;limitstart=<?php echo JRequest::getInt('limitstart',0); ?>&amp;mylimit=<?php echo JRequest::getInt('mylimit',20); ?>&amp;order=<?php echo JRequest::getVar('order', 'DESC') == 'DESC' ? 'ASC' : 'DESC'; ?>&amp;orderBy=paypal_tx_id"><?php echo BFText::_( 'Payment Tx ID' ); ?></a>
            </th>
            <th>
                <a href="index.php?option=com_breezingforms&amp;act=recordmanagement&amp;txtsearch=<?php echo JRequest::getWord('txtsearch','false'); ?>&amp;search=<?php echo htmlentities(JRequest::getVar('search',''), ENT_QUOTES, 'UTF-8'); ?>&amp;form=<?php echo htmlentities(JRequest::getVar('form',''), ENT_QUOTES, 'UTF-8'); ?>&amp;task=<?php echo JRequest::getVar('task',''); ?>&amp;limitstart=<?php echo JRequest::getInt('limitstart',0); ?>&amp;mylimit=<?php echo JRequest::getInt('mylimit',20); ?>&amp;order=<?php echo JRequest::getVar('order', 'DESC') == 'DESC' ? 'ASC' : 'DESC'; ?>&amp;orderBy=paypal_payment_date"><?php echo BFText::_( 'Payment Tx Date' ); ?></a>
            </th>
            <th>
                <a href="index.php?option=com_breezingforms&amp;act=recordmanagement&amp;txtsearch=<?php echo JRequest::getWord('txtsearch','false'); ?>&amp;search=<?php echo htmlentities(JRequest::getVar('search',''), ENT_QUOTES, 'UTF-8'); ?>&amp;form=<?php echo htmlentities(JRequest::getVar('form',''), ENT_QUOTES, 'UTF-8'); ?>&amp;task=<?php echo JRequest::getVar('task',''); ?>&amp;limitstart=<?php echo JRequest::getInt('limitstart',0); ?>&amp;mylimit=<?php echo JRequest::getInt('mylimit',20); ?>&amp;order=<?php echo JRequest::getVar('order', 'DESC') == 'DESC' ? 'ASC' : 'DESC'; ?>&amp;orderBy=paypal_testaccount"><?php echo BFText::_( 'Payment Test-Account?' ); ?></a>
            </th>
            <th>
            ...
            <th nowrap align="center"><?php echo BFText::_('RECORDS_VIEWED'); ?></th>
			<th nowrap align="center"><?php echo BFText::_('RECORDS_EXPORTED'); ?></th>
			<th nowrap align="center"><?php echo BFText::_('RECORDS_ARCHIVED'); ?></th>
        </tr>
    </thead>
    <?php
    $k = 0;
    ...
    for ($i=0; $i < $cnt; $i++)
    {
        ...
        <tr class="<?php echo "row$k"; ?>">
			...
			<td nowrap align="left"><?php echo $row->paypal_testaccount ? BFText::_('YES') : BFText::_('NO'); ?></td>
