...
?>
		...
		<table cellpadding="4" cellspacing="1" border="0" class="adminform" style="width:300px;">
			<tr><th colspan="6" class="title" >BreezingForms <?php echo $ff_version.' - '.BFText::_('CONFIG'); ?></th></tr>
			<tr>
				<td></td>
				<td nowrap><?php echo BFText::_('CONFIG_USELIVESITE'); ?></td>
				<td nowrap colspan="3">
<?php
					echo mosHTML::yesnoRadioList("livesite", "", $ff_config->livesite);
					echo mosToolTip(BFText::_('CONFIG_TIPLIVESITE'));
?>
				</td>
				<td></td>
			</tr>
			<tr>
				<td></td>
				<td nowrap><?php echo BFText::_('CONFIG_PREVIEWFRAME'); ?></td>
				<td nowrap colspan="3">
<?php
					echo mosHTML::yesnoRadioList("stylesheet", "", $ff_config->stylesheet);
					echo mosToolTip(BFText::_('CONFIG_TIPPREVIEW'));
?>
				</td>
				<td></td>
			</tr>
			<tr>
				<td></td>
				<td nowrap><?php echo BFText::_('CONFIG_GRIDSIZE'); ?></td>
				<td nowrap colspan="3">
					<input size="4" maxlength="4" name="gridsize" value="<?php echo $ff_config->gridsize; ?>"/>
					&nbsp;&nbsp;<?php echo BFText::_('CONFIG_COLOR'); ?> 1 <input size="7" maxlength="20" name="gridcolor1" value="<?php echo $ff_config->gridcolor1; ?>"/>
					&nbsp;&nbsp;<?php echo BFText::_('CONFIG_COLOR'); ?> 2 <input size="7" maxlength="20" name="gridcolor2" value="<?php echo $ff_config->gridcolor2; ?>"/>
				</td>
				<td></td>
			</tr>
			<tr>
				<td></td>
				<td nowrap><?php echo BFText::_('CONFIG_USEWYSIWYG'); ?></td>
				<td nowrap colspan="3">
<?php
					echo mosHTML::yesnoRadioList("wysiwyg", "", $ff_config->wysiwyg);
					echo mosToolTip(BFText::_('CONFIG_TIPWYSIWYG'));
?>
				</td>
				<td></td>
			</tr>
			<tr>
				<td></td>
				<td nowrap><?php echo BFText::_('CONFIG_COMPRESS'); ?></td>
				<td nowrap colspan="3">
<?php
					echo mosHTML::yesnoRadioList("compress", "", $ff_config->compress);
					echo mosToolTip(BFText::_('CONFIG_TIPCOMPRESS'));
?>
				</td>
				<td></td>
			</tr>
			<tr>
				<td></td>
				<td nowrap><?php echo BFText::_('CONFIG_GETPROVIDER'); ?></td>
				<td nowrap colspan="3">
<?php
					echo mosHTML::yesnoRadioList("getprovider", "", $ff_config->getprovider);
					echo mosToolTip(BFText::_('CONFIG_TIPPROVIDER'));
?>
				</td>
				<td></td>
			</tr>
			<tr>
				<td></td>
				<td></td>
				<td nowrap><?php echo BFText::_('CONFIG_SMALL'); ?></td>
				<td nowrap><?php echo BFText::_('CONFIG_MEDIUM'); ?></td>
				<td nowrap width="100%"><?php echo BFText::_('CONFIG_LARGE'); ?></td>
				<td></td>
			</tr>
			<tr>
				<td></td>
				<td nowrap><?php echo BFText::_('CONFIG_TEXTAREA'); ?></td>
			...
			<tr>
				<td></td>
				<td nowrap><?php echo BFText::_('CONFIG_LIMITDESC'); ?></td>
				<td nowrap colspan="3"><input size="6" maxlength="6" name="limitdesc" value="<?php echo $ff_config->limitdesc; ?>"/> <?php echo BFText::_('CONFIG_CHARS'); ?></td>
				<td></td>
			</tr>
			<tr>
				<td></td>
				<td nowrap><?php echo BFText::_('CONFIG_DEFAULTEMAIL'); ?></td>
				<td nowrap colspan="3"><input name="emailadr" value="<?php echo $ff_config->emailadr; ?>"/></td>
				<td></td>
			</tr>
			<tr>
				<td></td>
				<td nowrap><?php echo BFText::_('CONFIG_FFIMAGES'); ?></td>
				<td nowrap colspan="3"><input size="70" maxlength="255" name="images" value="<?php echo $ff_config->images; ?>"/></td>
				<td></td>
			</tr>
			<tr>
				<td></td>
				<td nowrap><?php echo BFText::_('CONFIG_FFUPLOADS'); ?></td>
				<td nowrap colspan="3"><input size="70" maxlength="255" name="uploads" value="<?php echo $ff_config->uploads; ?>"/></td>
				<td></td>
			</tr>
                         <tr>
				<td></td>
				<td nowrap><?php echo BFText::_('CONFIG_CSVDELIMITER'); ?></td>
				...
				<td></td>
                        ...
                        <tr>
				<td></td>
				<td nowrap><?php echo BFText::_('CONFIG_CSVQUOTE'); ?></td>
				...
				<td></td>
                        ...
                        <tr>
				<td></td>
				<td nowrap><?php echo BFText::_('CONFIG_CSVQUOTENEWLINE'); ?></td>
                                <td nowrap colspan="3"><input type="radio" name="cellnewline" value="0"<?php echo $ff_config->cellnewline == 0 ? ' checked="checked"' : '' ?>/> <?php echo BFText::_('CONFIG_CSVQUOTENEWLINE_REGULAR'); ?> <input type="radio" name="cellnewline" value="1"<?php echo $ff_config->cellnewline != 0 ? ' checked="checked"' : '' ?>/> <?php echo BFText::_('CONFIG_CSVQUOTENEWLINE_QUOTED'); ?></td>
				<td></td>
			</tr>
			<tr>
				<td></td>
				<td nowrap colspan="4" style="text-align:right"><br/>
					...
					<a class="toolbar" href="javascript:submitbutton('instpackage');" onmouseout="MM_swapImgRestore();"  onmouseover="MM_swapImage('instpackage','','images/upload_f2.png',1);">
						<img src="images/upload.png" alt="" name="instpackage" border="0" align="middle" />&nbsp;<?php echo BFText::_('TOOLBAR_PKGINSTLR'); ?>
					</a>&nbsp;&nbsp;
					<a class="toolbar" href="javascript:submitbutton('makepackage');" onmouseout="MM_swapImgRestore();"  onmouseover="MM_swapImage('makepackage','','<?php echo $ff_admicon; ?>/download_f2.png',1);">
						<img src="<?php echo $ff_admicon; ?>/download.png"  alt="" name="makepackage" border="0" align="middle" />&nbsp;<?php echo BFText::_('TOOLBAR_CREAPKG'); ?>
					</a>&nbsp;&nbsp;
...
<?php
	...
	function instPackage($option, $caller, $pkg, &$rows)
	{
		...
		if (file_exists($ff_admpath.'/packages/samples.'.$mosConfig_lang.'.xml'))
			$startdir = '{mospath}/administrator/components/com_breezingforms/packages/samples.'.$mosConfig_lang.'.xml';
		else
			...
			switch (pressbutton) {
				case 'delpkgs':
					if (form.boxchecked.value==0) {
						alert("<?php echo BFText::_('INSTALLER_SELPKGSFIRST'); ?>");
						return;
					} // if
					break;
				default:
				...
				case 'start':
					if (form.uploadpackage.checked) {
						if (form.uploadfile.value == '') {
							alert("<?php echo BFText::_('INSTALLER_NOUPLOADFILE'); ?>");
						...
						if (form.localpackage.checked) {
							if (form.installfile.value == '') {
								alert("<?php echo BFText::_('INSTALLER_NOFILENAME'); ?>");
								form.installfile.focus();
								return;
							} // if
							pressbutton = 'localpackage';
						} else {
							alert("<?php echo BFText::_('INSTALLER_SELECTMODE'); ?>");
							return;
						} // if
					break;
				case 'delpkgs':
					if (!confirm("<?php echo BFText::_('INSTALLER_ASKUNINST'); ?>")) return;
					break;
				default:
					break;
			} // switch
			...
			<tr>
				<td nowrap>
					<table class="adminheading">
						<tr><th class="sections">BreezingForms : <span class="componentheading"><?php echo BFText::_('INSTALLER_INSTALLPKG'); ?></span></th></tr>
					</table>
				</td>
				<td nowrap width="50">
				</td>
...
?>
					...
					<label for="uploadpackage"> <?php echo BFText::_('INSTALLER_CLIENTUPLOAD'); ?></label>
					<br/>
					<input type="radio" id="localpackage" name="tasksel" value="1" onclick="clickInstMode(this.value)"<?php echo $loclattr; ?>/>
					<label for="localpackage"> <?php echo BFText::_('INSTALLER_SERVERINSTALL'); ?></label>
		...
		<table cellpadding="4" cellspacing="0" border="0" width="100%" class="adminlist">
			<tr>
				...
				<th nowrap colspan="4" align="left"><?php echo BFText::_('INSTALLER_PACKAGE'); ?></th>
				<th nowrap colspan="2" align="left"><?php echo BFText::_('INSTALLER_AUTHOR'); ?></th>
			</tr>
<?php
			$k = 0;
...
?>
				<tr class="row<?php echo $k; ?>">
					...
					<td nowrap valign="top" align="left">
						<strong><?php echo BFText::_('INSTALLER_ID'); ?></strong><br/>
						<strong><?php echo BFText::_('INSTALLER_NAME'); ?></strong><br/>
						<strong><?php echo BFText::_('INSTALLER_VERS'); ?></strong><br/>
						<strong><?php echo BFText::_('INSTALLER_CREATEDATE'); ?></strong>
					</td>
					<td nowrap valign="top" align="left">
					...
					<td nowrap valign="top" align="left">
						<br/>
						<strong><?php echo BFText::_('INSTALLER_TITLE'); ?></strong><br/>
						<strong><?php echo BFText::_('INSTALLER_DESC'); ?></strong><br/>
						<strong><?php echo BFText::_('INSTALLER_CPYRT'); ?></strong>
					</td>
					<td nowrap valign="top" align="left">
						<br/>
					...
					<td nowrap valign="top" align="left">
						<br/>
						<strong><?php echo BFText::_('INSTALLER_NAME'); ?></strong><br/>
						<strong><?php echo BFText::_('INSTALLER_EMAIL'); ?></strong><br/>
						<strong><?php echo BFText::_('INSTALLER_URL'); ?></strong>
					</td>
...
?>
			...
			function submitbutton( pressbutton )
			{
				if (pressbutton == 'mkpackage') {
					...
					if (form.pkg_name.value=='') {
						error += "<?php echo BFText::_('INSTALLER_ENTPACKAGENAME'); ?>\n";
						if (foc=='') foc = form.pkg_name;
					} else
						if (invalidChars.test(form.pkg_name.value)) {
							error += "<?php echo BFText::_('INSTALLER_ENTIDENTIFIER'); ?>\n";
							if (foc=='') foc = form.pkg_name;
						} // if
					if (form.pkg_version.value=='') {
						error += "<?php echo BFText::_('INSTALLER_ENTVERSION'); ?>\n";
						if (foc=='') foc = form.pkg_version;
					} // if
					if (form.pkg_title.value=='') {
						error += "<?php echo BFText::_('INSTALLER_ENTTITLE'); ?>\n";
						if (foc=='') foc = form.pkg_title;
					} // if
					if (form.pkg_author.value=='') {
						error += "<?php echo BFText::_('INSTALLER_ENTAUTHORNM'); ?>\n";
						if (foc=='') foc = form.pkg_author;
					} // if
					if (form.pkg_email.value=='') {
						error += "<?php echo BFText::_('INSTALLER_ENTAUTHORMAIL'); ?>\n";
						if (foc=='') foc = form.pkg_email;
					} // if
					if (form.pkg_url.value=='') {
						error += "<?php echo BFText::_('INSTALLER_ENTAUTHORURL'); ?>\n";
						if (foc=='') foc = form.pkg_url;
					} // if
					if (form.pkg_description.value=='') {
						error += "<?php echo BFText::_('INSTALLER_ENTDESCR'); ?>\n";
						if (foc=='') foc = form.pkg_description;
					} // if
					if (form.pkg_copyright.value=='') {
						error += "<?php echo BFText::_('INSTALLER_ENTCOPYRT'); ?>\n";
					...
					if (form.pkg.value=='') {
						...
						for (i = 0; i < opts.length; i++) if (opts[i].selected) cnt++;
						if (cnt == 0)
							error += "<?php echo BFText::_('INSTALLER_SELECTAPKG'); ?>\n";
					} // if
					if (error) {
						alert(error);
						if (foc != '') foc.focus();
		...
		<form action="index2.php" method="post" name="adminForm">
		<table cellpadding="4" cellspacing="1" border="0" class="adminform" style="width:300px;">
			<tr><th colspan="4" class="title" >BreezingForms - <?php echo BFText::_('INSTALLER_CREATEPKG'); ?></th></tr>
			<tr>
				<td></td>
				<td colspan="2">
					<table width="100%" cellpadding="0" cellspacing="0" border="0">
						<tr>
							<td nowrap><?php echo BFText::_('INSTALLER_ID'); ?>:</td>
							<td nowrap width="100%">
...
?>
						...
						<tr>
							<td nowrap><?php echo BFText::_('INSTALLER_PACKAGE').' '.BFText::_('INSTALLER_NAME'); ?>:</td>
							<td nowrap width="100%"><input type="text" name="pkg_name" size="30" maxlength="30"/></td>
						</tr>
						<tr>
							<td nowrap><?php echo BFText::_('INSTALLER_PACKAGE').' '.BFText::_('INSTALLER_VERS'); ?>:</td>
							<td nowrap><input type="text" name="pkg_version" size="30" maxlength="30"/></td>
						</tr>
						<tr>
							<td nowrap><?php echo BFText::_('INSTALLER_PACKAGE').' '.BFText::_('INSTALLER_TITLE'); ?>:</td>
							<td nowrap width="100%"><input type="text" name="pkg_title" size="50" maxlength="50"/></td>
						</tr>
						<tr>
							<td nowrap><?php echo BFText::_('INSTALLER_AUTHOR').' '.BFText::_('INSTALLER_NAME'); ?>:</td>
							<td nowrap><input type="text" name="pkg_author" size="50" maxlength="50"/></td>
						</tr>
						<tr>
							<td nowrap><?php echo BFText::_('INSTALLER_AUTHOR').' '.BFText::_('INSTALLER_EMAIL'); ?>:</td>
							<td nowrap><input type="text" name="pkg_email" size="50" maxlength="50"/></td>
						</tr>
						<tr>
							<td nowrap><?php echo BFText::_('INSTALLER_AUTHOR').' '.BFText::_('INSTALLER_URL'); ?>:</td>
							<td nowrap><input type="text" name="pkg_url" size="50" maxlength="50"/></td>
						</tr>
						<tr>
							<td nowrap><?php echo BFText::_('INSTALLER_DESC'); ?>:</td>
							<td nowrap><input type="text" name="pkg_description" size="100" maxlength="100"/></td>
						</tr>
						<tr>
							<td nowrap><?php echo BFText::_('INSTALLER_CPYRT'); ?>:</td>
			...
			<tr id="menusel" style="display:none;">
				<td></td>
				<td>
					<fieldset><legend><?php echo BFText::_('INSTALLER_FORMSEL'); ?></legend>
...
?>
								...
								<input class="button" type="button" value="<?php echo BFText::_('INSTALLER_SELECTALL'); ?>" onclick="setSelection(1,true)" />&nbsp;
								<input class="button" type="button" value="<?php echo BFText::_('INSTALLER_CLRSELECTION'); ?>" onclick="setSelection(1,false)" />
							</td>
						</tr>
					</table>
					</fieldset>
				...
				<td>
					<fieldset><legend><?php echo BFText::_('INSTALLER_MENUSEL'); ?></legend>
					<table align="center" cellpadding="4" cellspacing="1" border="0">
						<tr>
							<td nowrap style="text-align:center">
...
?>
								...
								<input class="button" type="button" value="<?php echo BFText::_('INSTALLER_SELECTALL'); ?>" onclick="setSelection(2,true)" />&nbsp;
								<input class="button" type="button" value="<?php echo BFText::_('INSTALLER_CLRSELECTION'); ?>" onclick="setSelection(2,false)" />
							</td>
						</tr>
					</table>
					</fieldset>
			...
			<tr id="scriptsel" style="display:none;">
				<td></td>
				<td>
					<fieldset><legend><?php echo BFText::_('INSTALLER_SCRIPTSEL'); ?></legend>
					<table align="center" cellpadding="4" cellspacing="1" border="0">
						<tr>
							<td nowrap style="text-align:center">
...
?>
								...
								<input class="button" type="button" value="<?php echo BFText::_('INSTALLER_SELECTALL'); ?>" onclick="setSelection(3,true)" />&nbsp;
								<input class="button" type="button" value="<?php echo BFText::_('INSTALLER_CLRSELECTION'); ?>" onclick="setSelection(3,false)" />
							</td>
						</tr>
					</table>
					</fieldset>
				...
				<td>
					<fieldset><legend><?php echo BFText::_('INSTALLER_PIECESEL'); ?></legend>
					<table align="center" cellpadding="4" cellspacing="1" border="0">
						<tr>
							<td nowrap style="text-align:center">
...
?>
								...
								<input class="button" type="button" value="<?php echo BFText::_('INSTALLER_SELECTALL'); ?>" onclick="setSelection(4,true)" />&nbsp;
								<input class="button" type="button" value="<?php echo BFText::_('INSTALLER_CLRSELECTION'); ?>" onclick="setSelection(4,false)" />
							</td>
						</tr>
					</table>
					</fieldset>
...
?>
		...
		<table cellpadding="0" cellspacing="0" border="0" class="adminform" style="width:600px;">
			<tr><th colspan="4" class="title" >BreezingForms - <?php echo BFText::_('INSTALLER_PKGREPORT'); ?></th></tr>
<?php
...
?>
			<tr>
				<td></td>
				<td nowrap><?php echo BFText::_('INSTALLER_INSTTYPE'); ?>:</td>
				<td nowrap width="100%"><?php HTML_facileFormsConf::showParam($inst, 'pkgtype'); ?></td>
				<td></td>
			</tr>
			<tr>
				<td></td>
				<td nowrap><?php echo BFText::_('INSTALLER_FFVERSION'); ?>:</td>
			...
			<tr>
				<td></td>
				<td nowrap valign="top"><?php echo BFText::_('INSTALLER_DESC'); ?>:</td>
			...
			<tr>
				<td></td>
				<td nowrap><?php echo BFText::_('INSTALLER_CREATEDATE'); ?>:</td>
			...
			<tr>
				<td></td>
				<td nowrap><?php echo BFText::_('INSTALLER_SCRIPTSIMP'); ?>:</td>
				<td nowrap><?php echo count($inst->scripts); ?></td>
				<td></td>
			</tr>
			<tr>
				<td></td>
				<td nowrap><?php echo BFText::_('INSTALLER_PIECESIMP'); ?>:</td>
				<td nowrap><?php echo count($inst->pieces); ?></td>
				<td></td>
			</tr>
			<tr>
				<td></td>
				<td nowrap><?php echo BFText::_('INSTALLER_FORMSIMP'); ?>:</td>
				<td nowrap><?php echo count($inst->forms); ?></td>
				<td></td>
			</tr>
			<tr>
				<td></td>
				<td nowrap><?php echo BFText::_('INSTALLER_ELEMSIMP'); ?>:</td>
				<td nowrap><?php echo count($inst->elements); ?></td>
				<td></td>
			</tr>
			<tr>
				<td></td>
				<td nowrap><?php echo BFText::_('INSTALLER_MENUSIMP'); ?>:</td>
...
?>
			<tr>
				...
				<td nowrap colspan="2">
					<hr/><br/>
					<?php echo BFText::_('INSTALLER_WARNINGS'); ?>:<br/><br/>
<?php
